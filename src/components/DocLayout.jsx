...
export const ALL_DOC_PAGES = [
  ...
  { to: '/docs/api/execution',       label: 'Execution Control',       group: 'API Reference' },
  ...
  { to: '/docs/api/security',        label: 'Security Model',          group: 'API Reference' },
  { to: '/docs/api/llm',             label: 'LLMs',                    group: 'API Reference' },
  { to: '/docs/api/tools',           label: 'Tools',                   group: 'API Reference' },
  { to: '/docs/api/builtin-nodes',   label: 'Built-in Nodes',          group: 'API Reference' },
  { to: '/docs/api/nodes',           label: 'Advanced Nodes',          group: 'API Reference' },
  { to: '/docs/api/memory',          label: 'Memory & Checkpointing',  group: 'API Reference' },
  { to: '/docs/api/rag',             label: 'RAG',                     group: 'API Reference' },
  { to: '/docs/api/evaluation',      label: 'Evaluation',              group: 'API Reference' },
