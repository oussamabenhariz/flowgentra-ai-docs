    ...
    return "finalize"`} />
      ...
      <Section id="llm-calls" title="LLM Calls">
        <ul style={{ color: '#8b949e', lineHeight: 1.7, paddingLeft: 20, marginBottom: 16 }}>
          ...
          <li><strong style={{ color: '#e6edf3' }}>Add retries to all LLMs.</strong> Networks fail. Rate limits happen. <code style={{ background: '#161b22', padding: '2px 6px', borderRadius: 3, fontSize: '0.9em' }}>client.with_retry(max_retries=3)</code> costs almost nothing and prevents a lot of pain.</li>
