...
async fn main() -> Result<()> {
    ...
    Ok(())
}`,ir=`from flowgentra_ai.graph import StateGraph, END
...
# Hello, world! 👋`})]}),(0,j.jsxs)(fr,{id:`two-patterns`,title:`Two Patterns`,children:[(0,j.jsxs)(`p`,{style:{color:`#8b949e`,lineHeight:1.75,marginBottom:24},children:[`Flowgentra supports two complementary ways to build agents. Both work in `,t?`Rust`:`Python`,`.`]}),(0,j.jsx)(pr,{number:`1`,title:`Code-Driven`,badge:`Good for: scripts, prototypes`,description:`Define the graph entirely in code. Best for small agents where the graph topology is fixed.`,children:(0,j.jsx)(M,{rust:`// All wiring in code
let graph = StateGraph::<MyState>::builder()
    .add_node("a", node_a)
    .add_node("b", node_b)
    .add_edge("a", "b")
...
graph = builder.compile()`})}),(0,j.jsx)(pr,{number:`2`,title:`Config-Driven`,badge:`Recommended for production`,description:`Define topology in YAML, handlers in code with @register_handler. Swap configs without recompiling.`,children:(0,j.jsx)(M,{rust:`// agent.yaml defines the graph
...
]}`})}),(0,j.jsx)(hr,{title:`Requirements`,children:(0,j.jsxs)(`ul`,{style:{color:`#8b949e`,lineHeight:2,paddingLeft:20},children:[(0,j.jsxs)(`li`,{children:[`Rust `,(0,j.jsx)(`strong`,{style:{color:`#e6edf3`},children:`1.75+`})]}),(0,j.jsx)(`li`,{children:`Tokio async runtime`}),(0,j.jsx)(`li`,{children:`Cargo 1.75+`})]})}),(0,j.jsx)(hr,{title:`Verify`,children:(0,j.jsx)(M,{forceLang:`bash`,rust:`cargo add flowgentra
cargo build`})})]}):(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(hr,{title:`pip (Python)`,subtitle:`Install from PyPI:`,children:(0,j.jsx)(M,{forceLang:`bash`,python:`pip install flowgentra-ai`})}),(0,j.jsx)(hr,{title:`With extras`,children:(0,j.jsx)(M,{forceLang:`bash`,python:`# Include all optional integrations
pip install "flowgentra-ai[all]"

# Or individually
pip install "flowgentra-ai[openai]"
pip install "flowgentra-ai[anthropic]"
pip install "flowgentra-ai[tracing]"`})}),(0,j.jsx)(hr,{title:`Requirements`,children:(0,j.jsxs)(`ul`,{style:{color:`#8b949e`,lineHeight:2,paddingLeft:20},children:[(0,j.jsxs)(`li`,{children:[`Python `,(0,j.jsx)(`strong`,{style:{color:`#e6edf3`},children:`3.10+`})]}),(0,j.jsx)(`li`,{children:`Works in both sync and async contexts`})]})}),(0,j.jsx)(hr,{title:`Verify`,children:(0,j.jsx)(M,{forceLang:`bash`,python:`python -c "import flowgentra_ai; print(flowgentra_ai.__version__)"`})}),(0,j.jsx)(hr,{title:`Virtual environment (recommended)`,children:(0,j.jsx)(M,{forceLang:`bash`,python:`python -m venv .venv
source .venv/bin/activate  # Windows: .venv\\Scripts\\activate
pip install flowgentra-ai`})}),(0,j.jsxs)(hr,{title:`Import style`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:12,fontSize:`0.9375rem`},children:`Import from the appropriate submodule — not from the top-level package:`}),(0,j.jsx)(M,{forceLang:`bash`,python:`# Correct — submodule imports
...
from flowgentra_ai.observability import ExecutionTracer`})]})]})]})}function hr({title:e,subtitle:t,children:n}){return(0,j.jsxs)(`div`,{style:{marginBottom:40},children:[(0,j.jsx)(`h2`,{style:{fontSize:`1.25rem`,fontWeight:600,color:`#e6edf3`,marginBottom:t?6:14,marginTop:0},children:e}),t&&(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:12},children:t}),n]})}var gr=[{id:`overview`,label:`Overview`},{id:`mental-model`,label:`Mental Model`},{id:`core-primitives`,label:`Core Primitives`},{id:`engine-features`,label:`Engine Features`},{id:`two-patterns`,label:`Two Patterns`},{id:`languages`,label:`Languages`},{id:`next-steps`,label:`Next Steps`}];function _r(){let{language:e}=Zn();return(0,j.jsxs)(lr,{anchors:gr,children:[(0,j.jsx)(`h1`,{style:{fontSize:`2rem`,fontWeight:700,color:`#e6edf3`,letterSpacing:`-0.02em`,marginBottom:8,marginTop:0},children:`What is Flowgentra?`}),(0,j.jsxs)(`p`,{style:{color:`#8b949e`,marginBottom:40,lineHeight:1.7},children:[`Flowgentra is a framework for building `,(0,j.jsx)(`strong`,{style:{color:`#e6edf3`},children:`AI agent workflows`}),`. It gives you the building blocks to create anything from a simple LLM-powered function to a complex multi-agent system with memory, tools, evaluation, and observability.`]}),(0,j.jsx)(vr,{id:`overview`,title:`Overview`,children:(0,j.jsxs)(`p`,{style:{color:`#8b949e`,lineHeight:1.75,margin:0},children:[`The core idea is simple: your agent logic is a `,(0,j.jsx)(`strong`,{style:{color:`#e6edf3`},children:`graph`}),`. Nodes are functions. Edges connect them. State flows through.`]})}),(0,j.jsxs)(vr,{id:`mental-model`,title:`The Mental Model`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Think of your agent as a flowchart:`}),(0,j.jsx)(`div`,{style:{background:`#0d1117`,border:`1px solid #21262d`,borderRadius:8,padding:`20px`,marginBottom:20,fontFamily:`monospace`,fontSize:`0.9rem`,color:`#8b949e`,textAlign:`center`},children:`          ┌─────────────┐
Input ───►│  Classify   │
          └──────┬──────┘
                 │
        ┌────────┴────────┐
...
result = agent.run_with_input("Hello!")`}),(0,j.jsx)(`h3`,{style:{color:`#e6edf3`,fontSize:`1.25rem`,fontWeight:600,marginBottom:12,marginTop:20},children:`2. Code-first (direct API)`}),(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Build the graph programmatically. Best for complex logic with non-trivial routing.`}),(0,j.jsx)(M,{python:`builder = StateGraph()
...
graph = builder.compile()`}),(0,j.jsx)(`h3`,{style:{color:`#e6edf3`,fontSize:`1.25rem`,fontWeight:600,marginBottom:12,marginTop:20},children:`3. Config-driven (YAML + handlers)`}),(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Define the graph in YAML; write handlers in code. Best for production deployments where non-engineers need to adjust the flow.`}),(0,j.jsx)(M,{yaml:`# agent.yaml
name: my-agent
graph:
  entry: fetch
  edges:
...
)`}),(0,j.jsx)(`h3`,{style:{color:`#e6edf3`,fontSize:`1.25rem`,fontWeight:600,marginBottom:12,marginTop:20},children:`Timeout Node`}),(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Kills the function if it takes too long.`}),(0,j.jsx)(M,{rust:`.add_timeout_node("slow_op", slow_fn, TimeoutConfig {
    timeout_ms: 5000,
...
# on_timeout="skip" returns the original state unchanged`})]})]})}function xr({id:e,title:t,children:n}){return(0,j.jsxs)(`section`,{id:e,style:{marginBottom:48},children:[(0,j.jsx)(`h2`,{style:{fontSize:`1.5rem`,fontWeight:600,color:`#e6edf3`,marginBottom:16,marginTop:0},children:t}),n]})}var Sr=[{id:`node-contract`,label:`The Node Contract`},{id:`node-types`,label:`Node Types`}];function Cr(){let{language:e}=Zn();return(0,j.jsxs)(lr,{anchors:Sr,children:[(0,j.jsx)(`h1`,{style:{fontSize:`2rem`,fontWeight:700,color:`#e6edf3`,letterSpacing:`-0.02em`,marginBottom:8,marginTop:0},children:`Nodes`}),(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:40,lineHeight:1.7},children:`A node is the fundamental unit of work in a Flowgentra graph. It's just a function.`}),(0,j.jsxs)(wr,{id:`node-contract`,title:`The Node Contract`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Every node must:`}),(0,j.jsxs)(`ol`,{style:{color:`#8b949e`,lineHeight:1.7,paddingLeft:20,marginBottom:16},children:[(0,j.jsxs)(`li`,{children:[`Accept a single `,(0,j.jsx)(`code`,{style:{background:`#161b22`,padding:`2px 6px`,borderRadius:3,fontSize:`0.9em`},children:`State`}),` argument (Python) or `,(0,j.jsx)(`code`,{style:{background:`#161b22`,padding:`2px 6px`,borderRadius:3,fontSize:`0.9em`},children:`DynState`}),` / your typed state (Rust)`]}),(0,j.jsxs)(`li`,{children:[`Return a `,(0,j.jsx)(`code`,{style:{background:`#161b22`,padding:`2px 6px`,borderRadius:3,fontSize:`0.9em`},children:`State`}),` (usually the same object, modified)`]})]}),(0,j.jsx)(M,{rust:`async fn my_node(mut state: DynState) -> Result<DynState> {
    let input = state.get_string("input").unwrap_or_default();
    let result = process(&input).await?;
    state.set("output", result);
    Ok(state)
    ...
    return state   # always return state`})]}),(0,j.jsxs)(wr,{id:`node-types`,title:`Node Types`,children:[(0,j.jsx)(`h3`,{style:{color:`#e6edf3`,fontSize:`1.25rem`,fontWeight:600,marginBottom:12,marginTop:20},children:`Regular Nodes`}),(0,j.jsxs)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:[`The default. A plain function added with `,(0,j.jsx)(`code`,{style:{background:`#161b22`,padding:`2px 6px`,borderRadius:3,fontSize:`0.9em`},children:`add_node`}),`.`]}),(0,j.jsx)(M,{python:`builder.add_node("process", process_fn)`}),(0,j.jsx)(`h3`,{style:{color:`#e6edf3`,fontSize:`1.25rem`,fontWeight:600,marginBottom:12,marginTop:20},children:`Retry Nodes`}),(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Automatically retries with exponential backoff when the function raises an exception.`}),(0,j.jsx)(M,{python:`builder.add_retry_node("fetch", fetch_fn, max_retries=3, backoff_ms=1000)`}),(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Use this for: API calls, database queries, network requests — anything that can fail transiently.`}),(0,j.jsx)(`h3`,{style:{color:`#e6edf3`,fontSize:`1.25rem`,fontWeight:600,marginBottom:12,marginTop:20},children:`Timeout Nodes`}),(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Terminates the function if it exceeds a time limit.`}),(0,j.jsx)(M,{python:`builder.add_timeout_node("slow_op", slow_fn, timeout_ms=5000, on_timeout="skip")`}),(0,j.jsxs)(`ul`,{style:{color:`#8b949e`,lineHeight:1.7,paddingLeft:20,marginBottom:16},children:[(0,j.jsxs)(`li`,{children:[(0,j.jsx)(`code`,{style:{background:`#161b22`,padding:`2px 6px`,borderRadius:3,fontSize:`0.9em`},children:`on_timeout="error"`}),` — raises an exception (default)`]}),(0,j.jsxs)(`li`,{children:[(0,j.jsx)(`code`,{style:{background:`#161b22`,padding:`2px 6px`,borderRadius:3,fontSize:`0.9em`},children:`on_timeout="skip"`}),` — returns the original state unchanged`]})]}),(0,j.jsx)(`h3`,{style:{color:`#e6edf3`,fontSize:`1.25rem`,fontWeight:600,marginBottom:12,marginTop:20},children:`LLM Nodes`}),(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`A pre-wired node that reads a prompt from state, calls an LLM, and writes the response.`}),(0,j.jsx)(M,{python:`builder.add_llm_node(
    "generate",
    client,
    prompt_key="user_query",
    output_key="llm_response",
    system_prompt="You are a helpful assistant.",
)`}),(0,j.jsx)(`h3`,{style:{color:`#e6edf3`,fontSize:`1.25rem`,fontWeight:600,marginBottom:12,marginTop:20},children:`Planner Nodes`}),(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Uses an LLM to decide the next node dynamically at runtime.`}),(0,j.jsx)(M,{python:`builder.add_planner_node("planner", client)`}),(0,j.jsxs)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:[`The planner reads `,(0,j.jsx)(`code`,{style:{background:`#161b22`,padding:`2px 6px`,borderRadius:3,fontSize:`0.9em`},children:`state["_reachable_nodes"]`}),` (a list of node names) and writes `,(0,j.jsx)(`code`,{style:{background:`#161b22`,padding:`2px 6px`,borderRadius:3,fontSize:`0.9em`},children:`state["_next_node"]`}),` (the chosen next node).`]}),(0,j.jsx)(`h3`,{style:{color:`#e6edf3`,fontSize:`1.25rem`,fontWeight:600,marginBottom:12,marginTop:20},children:`Evaluation Nodes`}),(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Wraps a node in an iterative refinement loop — runs the node, evaluates the output, and re-runs until quality meets a threshold.`})]})]})}function wr({id:e,title:t,children:n}){return(0,j.jsxs)(`section`,{id:e,style:{marginBottom:48},children:[(0,j.jsx)(`h2`,{style:{fontSize:`1.5rem`,fontWeight:600,color:`#e6edf3`,marginBottom:16,marginTop:0},children:t}),n]})}var Tr=[{id:`basics`,label:`The Basics`},{id:`creating`,label:`Creating State`},{id:`serialization`,label:`Serialization`}];function Er(){let{language:e}=Zn();return(0,j.jsxs)(lr,{anchors:Tr,children:[(0,j.jsx)(`h1`,{style:{fontSize:`2rem`,fontWeight:700,color:`#e6edf3`,letterSpacing:`-0.02em`,marginBottom:8,marginTop:0},children:`State Management`}),(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:40,lineHeight:1.7},children:`State is the data container that flows through your graph. Every node receives the current state, modifies it, and returns it. Understanding state is key to understanding how Flowgentra works.`}),(0,j.jsx)(Dr,{id:`basics`,title:`The Basics`,children:(0,j.jsx)(M,{rust:`use flowgentra_ai::DynState;
...
# Iterate
state.keys()            # ["user"]
len(state)              # 1`})}),(0,j.jsx)(Dr,{id:`creating`,title:`Creating State`,children:(0,j.jsx)(M,{rust:`// Empty
...
# Empty
state = State()`})}),(0,j.jsx)(Dr,{id:`serialization`,title:`Serialization`,children:(0,j.jsx)(M,{rust:`// To JSON string
...
Has tool calls?                                 │
    ...
    │
    └── No ───► [Final answer]`}),(0,j.jsx)(`p`,{style:{color:`#8b949e`,lineHeight:1.7,margin:0},children:`The agent loops until the LLM decides it has enough information and produces a final answer (no tool calls).`})]}),(0,j.jsxs)(Ar,{id:`few-shot-react`,title:`FewShotReAct`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Like ZeroShotReAct, but includes example interactions in the prompt to guide the agent's behavior in specialized domains.`}),(0,j.jsx)(M,{python:`# Add examples to the agent
agent = (
    ...
    .build_graph()
)`})]}),(0,j.jsxs)(Ar,{id:`conversational`,title:`Conversational`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`A conversational agent that maintains context across multiple turns. Perfect for chatbots and interactive assistants.`}),(0,j.jsx)(M,{python:`from flowgentra_ai.agent import AgentBuilder, AgentType
...
response3 = agent.execute_input("Tell me a joke about programming")`})]}),(0,j.jsxs)(Ar,{id:`config-driven`,title:`Config-Driven Agents`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Define your agent in YAML for production deployments where non-engineers need to adjust the workflow.`}),(0,j.jsx)(M,{yaml:`# agent.yaml
...
tools:
  ...
  - name: calculator
    ...
    parameters:
      expression: { type: string, required: true }`}),(0,j.jsx)(M,{python:`from flowgentra_ai.agent import Agent

agent = Agent.from_config_path("agent.yaml")
result = agent.run({"input": "What is 2 + 2?"})`})]}),(0,j.jsxs)(Ar,{id:`memory-aware`,title:`MemoryAwareAgent`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`A pre-built agent for multi-user chatbots with per-user conversation memory.`}),(0,j.jsx)(M,{python:`from flowgentra_ai.agent import MemoryAwareAgent
from flowgentra_ai.memory import ConversationMemory
...
alice_followup = agent.chat("alice-123", "What's my name?")  # Remembers Alice`})]})]})}function Ar({id:e,title:t,children:n}){return(0,j.jsxs)(`section`,{id:e,style:{marginBottom:48},children:[(0,j.jsx)(`h2`,{style:{fontSize:`1.5rem`,fontWeight:600,color:`#e6edf3`,marginBottom:16,marginTop:0},children:t}),n]})}var jr=[{id:`creating-client`,label:`Creating a Client`},{id:`sending-messages`,label:`Sending Messages`},{id:`tool-calling`,label:`Tool Calling`},{id:`streaming`,label:`Streaming`}];function Mr(){let{language:e}=Zn();return(0,j.jsxs)(lr,{anchors:jr,children:[(0,j.jsx)(`h1`,{style:{fontSize:`2rem`,fontWeight:700,color:`#e6edf3`,letterSpacing:`-0.02em`,marginBottom:8,marginTop:0},children:`LLM Integration`}),(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:40,lineHeight:1.7},children:`Flowgentra provides a unified LLM client that works with 7 providers. You configure it once and use the same API regardless of whether you're using OpenAI, Anthropic, or a local Ollama model.`}),(0,j.jsxs)(Nr,{id:`creating-client`,title:`Creating a Client`,children:[(0,j.jsx)(M,{rust:`use flowgentra_ai::llm::{LLMConfig, LLMClient};
...
print(response.role)      # "assistant"`})}),(0,j.jsxs)(Nr,{id:`tool-calling`,title:`Tool Calling`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Flowgentra supports function calling with all major providers. Define your tools and the LLM will call them automatically.`}),(0,j.jsx)(M,{python:`from flowgentra_ai.llm import ToolDefinition
...
print(f"Quality score: {score:.2f}")`}];function Gr(){return(0,j.jsxs)(lr,{anchors:Wr.map(e=>({id:e.id,label:e.title})),children:[(0,j.jsx)(`h1`,{style:{fontSize:`2rem`,fontWeight:700,color:`#e6edf3`,letterSpacing:`-0.02em`,marginBottom:8,marginTop:0},children:`Examples`}),(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:48,lineHeight:1.7},children:`Real-world usage patterns. Toggle between Rust and Python using the language switcher.`}),Wr.map((e,t)=>(0,j.jsxs)(`section`,{id:e.id,style:{marginBottom:60,paddingBottom:60,borderBottom:t<Wr.length-1?`1px solid #21262d`:`none`},children:[(0,j.jsx)(`div`,{style:{display:`flex`,alignItems:`baseline`,gap:12,marginBottom:8},children:(0,j.jsxs)(`span`,{style:{fontSize:`0.75rem`,fontWeight:600,color:`var(--accent)`,background:`var(--accent-dim)`,border:`1px solid var(--accent)`,borderRadius:10,padding:`2px 10px`},children:[`Example `,t+1]})}),(0,j.jsx)(`h2`,{style:{fontSize:`1.375rem`,fontWeight:600,color:`#e6edf3`,marginBottom:8,marginTop:0},children:e.title}),(0,j.jsx)(`p`,{style:{color:`#8b949e`,lineHeight:1.7,marginBottom:20},children:e.description}),(0,j.jsx)(M,{rust:e.rust,python:e.python})]},e.id))]})}var Kr=[{version:`0.1.3`,date:`2025-04-05`,tag:`latest`,changes:[{type:`fix`,text:"Python: all submodule imports now work correctly (use `from flowgentra_ai.graph import StateGraph`, not `from flowgentra import …`)"},{type:`fix`,text:"Python: `Agent.create()` now takes `model` string instead of `llm` LLMClient object; use `run_with_input(str)` on the returned agent"},{type:`fix`,text:"Python: `StateGraph.invoke()` accepts a plain `dict` — do not wrap with `State()`"},{type:`fix`,text:`Python: fixed 9 compile errors in PyO3 bindings (rayon, schema_version, tool extraction, GIL cloning, type mismatches)`},{type:`fix`,text:"Python: `conversation_memory.rs` extra brace syntax error resolved"},{type:`fix`,text:"Python: `LLMClient` constructor no longer requires a pre-built config object"},{type:`breaking`,text:'Python: `Agent.create(llm=…)` removed — pass `model="gpt-4o"` string instead'},{type:`breaking`,text:"Python: top-level `from flowgentra import StateGraph` removed — use submodule imports"},{type:`docs`,text:"Updated all code examples to use correct `flowgentra_ai.*` submodule import paths"}],rust:`# Cargo.toml
...
flowgentra = "0.4"`,python:`pip install "flowgentra==0.4.0"`},{version:`0.3.2`,date:`2024-10-15`,tag:null,changes:[{type:`fix`,text:"Python: handle `None` return values from node functions"},{type:`fix`,text:`Rust: correct borrow checker error with recursive graphs`},{type:`docs`,text:`Improve error messages for missing entry node`}],rust:`flowgentra = "0.3.2"`,python:`pip install "flowgentra==0.3.2"`},{version:`0.3.0`,date:`2024-09-01`,tag:null,changes:[{type:`feat`,text:`Initial Python bindings via PyO3`},{type:`feat`,text:`TypedDict state support in Python`},{type:`feat`,text:`Async node support in both languages`},{type:`breaking`,text:"Renamed `Graph::new` to `StateGraph::builder`"}],rust:`flowgentra = "0.3"`,python:`pip install "flowgentra==0.3.0"`}],qr={feat:{bg:`rgba(35,134,54,0.15)`,color:`#3fb950`,label:`feat`},fix:{bg:`rgba(248,81,73,0.15)`,color:`#f85149`,label:`fix`},perf:{bg:`rgba(53,114,165,0.15)`,color:`#79c0ff`,label:`perf`},docs:{bg:`rgba(139,148,158,0.15)`,color:`#8b949e`,label:`docs`},breaking:{bg:`rgba(210,153,34,0.15)`,color:`#e3b341`,label:`breaking`}};function Jr(){return(0,j.jsxs)(lr,{children:[(0,j.jsx)(`h1`,{style:{fontSize:`2rem`,fontWeight:700,color:`#e6edf3`,letterSpacing:`-0.02em`,marginBottom:8,marginTop:0},children:`Changelog`}),(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:48,lineHeight:1.7},children:`All notable changes to Flowgentra. The language switcher shows the install snippet for each version.`}),Kr.map((e,t)=>(0,j.jsxs)(`article`,{style:{marginBottom:52,paddingBottom:52,borderBottom:t<Kr.length-1?`1px solid #21262d`:`none`},children:[(0,j.jsxs)(`div`,{style:{display:`flex`,flexWrap:`wrap`,alignItems:`center`,gap:10,marginBottom:6},children:[(0,j.jsxs)(`h2`,{style:{fontFamily:`JetBrains Mono, monospace`,fontSize:`1.25rem`,color:`#e6edf3`,margin:0},children:[`v`,e.version]}),e.tag&&(0,j.jsx)(`span`,{style:{background:`rgba(35,134,54,0.15)`,color:`#3fb950`,border:`1px solid rgba(35,134,54,0.4)`,borderRadius:10,fontSize:`0.75rem`,padding:`2px 10px`,fontWeight:500},children:e.tag}),(0,j.jsx)(`span`,{style:{color:`#484f58`,fontSize:`0.875rem`,marginLeft:`auto`},children:e.date})]}),(0,j.jsx)(`ul`,{style:{listStyle:`none`,padding:0,margin:`16px 0 20px`},children:e.changes.map((t,n)=>{let r=qr[t.type]||qr.docs;return(0,j.jsxs)(`li`,{style:{display:`flex`,alignItems:`baseline`,gap:10,padding:`6px 0`,borderBottom:n<e.changes.length-1?`1px solid #161b22`:`none`},children:[(0,j.jsx)(`span`,{style:{background:r.bg,color:r.color,fontSize:`0.7rem`,fontWeight:600,padding:`2px 7px`,borderRadius:4,flexShrink:0,fontFamily:`JetBrains Mono, monospace`},children:r.label}),(0,j.jsx)(`span`,{style:{color:`#c9d1d9`,lineHeight:1.6,fontSize:`0.9375rem`},children:t.text})]},n)})}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`p`,{style:{fontSize:`0.8125rem`,color:`#8b949e`,marginBottom:8},children:`Install this version:`}),(0,j.jsx)(M,{rust:e.rust,python:e.python})]})]},e.version))]})}function Yr(){return(0,j.jsx)(Xn,{children:(0,j.jsx)(Dn,{basename:`/flowgentra-ai-docs`,children:(0,j.jsxs)(`div`,{style:{minHeight:`100vh`,display:`flex`,flexDirection:`column`},children:[(0,j.jsx)(er,{}),(0,j.jsx)(`div`,{style:{flex:1},children:(0,j.jsxs)(zt,{children:[(0,j.jsx)(A,{path:`/`,element:(0,j.jsx)(sr,{})}),(0,j.jsx)(A,{path:`/docs/getting-started`,element:(0,j.jsx)(dr,{})}),(0,j.jsx)(A,{path:`/docs/installation`,element:(0,j.jsx)(mr,{})}),(0,j.jsx)(A,{path:`/docs/what-is-flowgentra`,element:(0,j.jsx)(_r,{})}),(0,j.jsx)(A,{path:`/docs/concepts/graphs`,element:(0,j.jsx)(br,{})}),(0,j.jsx)(A,{path:`/docs/concepts/nodes`,element:(0,j.jsx)(Cr,{})}),(0,j.jsx)(A,{path:`/docs/concepts/state`,element:(0,j.jsx)(Er,{})}),(0,j.jsx)(A,{path:`/docs/guides/agents`,element:(0,j.jsx)(kr,{})}),(0,j.jsx)(A,{path:`/docs/guides/llm-client`,element:(0,j.jsx)(Mr,{})}),(0,j.jsx)(A,{path:`/docs/best-practices`,element:(0,j.jsx)(Fr,{})}),(0,j.jsx)(A,{path:`/docs/faq`,element:(0,j.jsx)(Rr,{})}),(0,j.jsx)(A,{path:`/docs/api/:topicId`,element:(0,j.jsx)(Ur,{})}),(0,j.jsx)(A,{path:`/docs/api-reference`,element:(0,j.jsx)(Lt,{to:`/docs/api/state-graph`,replace:!0})}),(0,j.jsx)(A,{path:`/docs/examples`,element:(0,j.jsx)(Gr,{})}),(0,j.jsx)(A,{path:`/docs/changelog`,element:(0,j.jsx)(Jr,{})}),(0,j.jsx)(A,{path:`/docs`,element:(0,j.jsx)(Lt,{to:`/docs/getting-started`,replace:!0})}),(0,j.jsx)(A,{path:`*`,element:(0,j.jsx)(Lt,{to:`/`,replace:!0})})]})})]})})})}(0,y.createRoot)(document.getElementById(`root`)).render((0,j.jsx)(v.StrictMode,{children:(0,j.jsx)(Yr,{})}));export{s as n,S as t};