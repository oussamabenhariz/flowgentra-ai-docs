...
result = agent.run_with_input("Hello!")`}),(0,j.jsx)(`h3`,{style:{color:`#e6edf3`,fontSize:`1.25rem`,fontWeight:600,marginBottom:12,marginTop:20},children:`2. Code-first (direct API)`}),(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Build the graph programmatically. Best for complex logic with non-trivial routing.`}),(0,j.jsx)(N,{python:`builder = StateGraph()
...
context = "\\n".join(f"{msg.role}: {msg.content}" for msg in recent)`})]}),(0,j.jsxs)(Pr,{id:`memory-aware-agents`,title:`Memory-Aware Agents`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Memory-aware agents automatically manage conversation history and can handle multi-turn conversations without manual state management.`}),(0,j.jsx)(N,{rust:`use flowgentra_ai::agent::MemoryAwareAgent;
...
graph = builder.compile()`})]}),(0,j.jsxs)(Lr,{id:`approval-workflows`,title:`Approval Workflows`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Common patterns for human approval in automated workflows.`}),(0,j.jsx)(`h3`,{style:{color:`#e6edf3`,fontSize:`1.25rem`,fontWeight:600,marginBottom:12,marginTop:20},children:`Content Moderation`}),(0,j.jsx)(N,{python:`def moderate_content(state):
...
# Graph: generate -> moderate -> human_review -> publish`}),(0,j.jsx)(`h3`,{style:{color:`#e6edf3`,fontSize:`1.25rem`,fontWeight:600,marginBottom:12,marginTop:20},children:`Code Deployment`}),(0,j.jsx)(N,{python:`def deploy_check(state):
...
def human_intervention(state):
    ...
    return state`})]}),(0,j.jsxs)(Lr,{id:`feedback-loops`,title:`Feedback & Corrections`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Use human feedback to improve future automation.`}),(0,j.jsx)(N,{python:`def collect_feedback(state):
...
# Combine all documents
all_docs = docs + web_docs`}),(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Flowgentra supports PDF, HTML, Markdown, JSON, CSV, and plain text files out of the box.`})]}),(0,j.jsxs)(Br,{id:`text-splitting`,title:`Text Splitting`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Split large documents into smaller chunks that fit within your model's context window.`}),(0,j.jsx)(N,{rust:`use flowgentra_ai::text_splitter::{RecursiveTextSplitter, ChunkConfig};
...
}`,python:`from flowgentra_ai.text_splitter import RecursiveTextSplitter

splitter = RecursiveTextSplitter(
    chunk_size=1000,        # Characters per chunk
    chunk_overlap=200,      # Overlap between chunks
    separators=["\\n\\n", "\\n", " ", ""]  # Split on paragraphs first, then sentences, etc.
)
...
# Each chunk has text, metadata, and source information
for chunk in chunks:
    print(f"Chunk: {len(chunk.text)} chars from {chunk.source}")`})]}),(0,j.jsxs)(Br,{id:`embeddings`,title:`Embeddings & Vector Stores`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Convert text chunks to vector embeddings and store them for fast retrieval.`}),(0,j.jsx)(N,{rust:`use flowgentra_ai::vector_store::{ChromaStore, EmbeddingConfig};

// Configure embeddings (OpenAI, local models, etc.)
let embedding_config = EmbeddingConfig::openai("text-embedding-3-small", api_key);

// Create vector store
let store = ChromaStore::new("./chroma_db", embedding_config).await?;

// Add documents
store.add_documents(chunks).await?;

// The store automatically handles embedding generation and indexing`,python:`from flowgentra_ai.vector_store import ChromaStore
from flowgentra_ai.embeddings import OpenAIEmbeddings
...
# Create vector store
store = ChromaStore("./chroma_db", embeddings)

# Add documents (automatically embeds and indexes)
store.add_documents(chunks)`}),(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Flowgentra supports Chroma, Qdrant, Weaviate, Pinecone, and other vector databases.`})]}),(0,j.jsxs)(Br,{id:`retrieval`,title:`Retrieval`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Find the most relevant documents for a user's query using semantic search.`}),(0,j.jsx)(N,{rust:`use flowgentra_ai::retrieval::{Retriever, RetrievalConfig};

let retriever = Retriever::new(store, RetrievalConfig {
    top_k: 5,                    // Return top 5 results
    score_threshold: Some(0.7),  // Minimum similarity score
...
// Results include text, metadata, and similarity scores
for result in &results {
    println!("Score: {:.3}, Text: {}...",
             result.score, &result.document.text[..100]);
}`,python:`from flowgentra_ai.retrieval import Retriever
...
# Results include text, metadata, and similarity scores
for result in results:
    print(f"Score: {result.score:.3f}, Text: {result.document.text[:100]}...")`})]}),(0,j.jsxs)(Br,{id:`generation`,title:`Generation with Context`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Use retrieved documents as context for generating accurate, grounded answers.`}),(0,j.jsx)(N,{rust:`#[derive(State)]
struct RAGState {
    query: String,
...
#[node]
async fn retrieve_and_generate(state: &mut RAGState) -> Result<()> {
    // Retrieve relevant documents
    let results = retriever.retrieve(&state.query).await?;
    state.context_docs = results.into_iter()
        .map(|r| r.document.text)
        .collect();

    // Build context string
    let context = state.context_docs.join("\\n\\n---\\n\\n");
    ...
    state.answer = llm.complete(&prompt).await?;
    Ok(())
}`,python:`class RAGState(TypedDict):
    query: str
    context_docs: List[str]
    answer: str

def retrieve_and_generate(state: RAGState) -> RAGState:
    # Retrieve relevant documents
...
def get_weather(city: str) -> dict:
    ...
    # Call weather API
    return {"temperature": 72, "condition": "sunny"}`}),(0,j.jsx)(`h3`,{style:{color:`#e6edf3`,fontSize:`1.25rem`,fontWeight:600,marginBottom:12,marginTop:20},children:`API Tools`}),(0,j.jsx)(N,{python:`import requests
...
print(response.final_answer)  # "15 * 23 = 345, and Tokyo is sunny with 72°F"`}),(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Tool calling is supported for OpenAI, Anthropic, and other providers that implement the tool calling protocol.`})]}),(0,j.jsxs)(Ur,{id:`builtin-tools`,title:`Built-in Tools`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Flowgentra includes many useful tools out of the box.`}),(0,j.jsx)(`div`,{style:{background:`#0d1117`,border:`1px solid #21262d`,borderRadius:8,padding:`20px`,marginBottom:20},children:(0,j.jsxs)(`table`,{style:{width:`100%`,borderCollapse:`collapse`,color:`#8b949e`},children:[(0,j.jsx)(`thead`,{children:(0,j.jsxs)(`tr`,{children:[(0,j.jsx)(`th`,{style:{textAlign:`left`,padding:`8px`,borderBottom:`1px solid #21262d`,color:`#e6edf3`},children:`Tool`}),(0,j.jsx)(`th`,{style:{textAlign:`left`,padding:`8px`,borderBottom:`1px solid #21262d`,color:`#e6edf3`},children:`Purpose`})]})}),(0,j.jsxs)(`tbody`,{children:[(0,j.jsxs)(`tr`,{children:[(0,j.jsx)(`td`,{style:{padding:`8px`,borderBottom:`1px solid #21262d`},children:`Calculator`}),(0,j.jsx)(`td`,{style:{padding:`8px`,borderBottom:`1px solid #21262d`},children:`Mathematical calculations`})]}),(0,j.jsxs)(`tr`,{children:[(0,j.jsx)(`td`,{style:{padding:`8px`,borderBottom:`1px solid #21262d`},children:`WebSearch`}),(0,j.jsx)(`td`,{style:{padding:`8px`,borderBottom:`1px solid #21262d`},children:`Search the web for information`})]}),(0,j.jsxs)(`tr`,{children:[(0,j.jsx)(`td`,{style:{padding:`8px`,borderBottom:`1px solid #21262d`},children:`FileSystem`}),(0,j.jsx)(`td`,{style:{padding:`8px`,borderBottom:`1px solid #21262d`},children:`Read and write files`})]}),(0,j.jsxs)(`tr`,{children:[(0,j.jsx)(`td`,{style:{padding:`8px`,borderBottom:`1px solid #21262d`},children:`HTTPClient`}),(0,j.jsx)(`td`,{style:{padding:`8px`,borderBottom:`1px solid #21262d`},children:`Make HTTP requests`})]}),(0,j.jsxs)(`tr`,{children:[(0,j.jsx)(`td`,{style:{padding:`8px`},children:`DateTime`}),(0,j.jsx)(`td`,{style:{padding:`8px`},children:`Date and time operations`})]})]})]})}),(0,j.jsx)(N,{python:`from flowgentra_ai.tools import builtin_tools
...
graph = builder.compile()`})]}),(0,j.jsxs)(Kr,{id:`timeout-nodes`,title:`Timeout Nodes`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Prevent slow operations from blocking your workflow indefinitely.`}),(0,j.jsx)(N,{rust:`use flowgentra_ai::nodes::{TimeoutNode, TimeoutConfig};
use std::time::Duration;
...
graph = builder.compile()`})]}),(0,j.jsxs)(Kr,{id:`fallback-nodes`,title:`Fallback Strategies`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`When primary operations fail, try alternative approaches.`}),(0,j.jsx)(N,{rust:`use flowgentra_ai::nodes::FallbackNode;
    ...
    def __call__(self, state):
        ...
        try:
            ...
            if self.failures >= self.failure_threshold:
                self.state = "open"
            raise`}),(0,j.jsx)(`h3`,{style:{color:`#e6edf3`,fontSize:`1.25rem`,fontWeight:600,marginBottom:12,marginTop:20},children:`Graceful Degradation`}),(0,j.jsx)(N,{python:`def robust_processing(state):
    try:
        # Try full processing
