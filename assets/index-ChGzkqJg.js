...
print(result.get("summary"))`})]}),(0,j.jsxs)(Bi,{id:`parallel`,title:`Parallel — Fan-Out / Fan-In`,children:[(0,j.jsx)(`p`,{style:Wi,children:`Run all child agents simultaneously and merge their results. The merge strategy controls how state is combined.`}),(0,j.jsx)(N,{rust:`use flowgentra_ai::supervision::{Supervisor, SupervisorNodeConfig, OrchestrationStrategy, ParallelMergeStrategy};
...
result = sup.run(initial_state)`}),(0,j.jsxs)(`div`,{style:{background:`#161b22`,border:`1px solid #21262d`,borderRadius:8,padding:`16px 20px`,marginTop:16},children:[(0,j.jsx)(`div`,{style:{fontWeight:600,color:`#e6edf3`,marginBottom:10,fontSize:`0.875rem`},children:`Merge Strategies`}),(0,j.jsx)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:8},children:[[`ParallelMergeStrategy.first_success()`,`Use result from whichever agent finishes first successfully`],[`ParallelMergeStrategy.latest()`,`Use result from the last agent to finish`],[`ParallelMergeStrategy.deep_merge()`,`Deep-merge all state dicts (new keys win, lists append)`]].map(([e,t])=>(0,j.jsxs)(`div`,{style:{display:`flex`,gap:12,alignItems:`baseline`},children:[(0,j.jsx)(`code`,{style:Gi,children:e}),(0,j.jsx)(`span`,{style:{color:`#8b949e`,fontSize:`0.875rem`},children:t})]},e))})]})]}),(0,j.jsxs)(Bi,{id:`llm-routed`,title:`LLM-Routed — Dynamic Dispatch`,children:[(0,j.jsx)(`p`,{style:Wi,children:`The supervisor calls an LLM to decide which agent runs next. The router can see the current state and choose dynamically. This is the most flexible strategy for complex, unknown workflows.`}),(0,j.jsx)(N,{rust:`// With router function
...
result = sup.run(initial_state)`}),(0,j.jsxs)(Vi,{type:`warn`,title:`Set a max_rounds limit`,children:[`LLM-routed supervisors can loop indefinitely if the router never returns "FINISH". Always set `,(0,j.jsx)(`code`,{style:Gi,children:`max_rounds()`}),` to prevent runaway execution.`]})]}),(0,j.jsx)(Bi,{id:`advanced`,title:`Advanced Strategies`,children:(0,j.jsx)(`div`,{style:{display:`grid`,gridTemplateColumns:`repeat(auto-fit, minmax(280px, 1fr))`,gap:14},children:[{title:`Map-Reduce`,desc:`Split a large input into chunks, send each to a child agent, then merge results. Perfect for document analysis.`,code:`config.set_strategy(
  OrchestrationStrategy.map_reduce()
)`},{title:`Debate`,desc:`Two or more agents generate competing answers, then a moderator agent synthesizes a final consensus.`,code:`config.set_strategy(
  OrchestrationStrategy.debate()
)`},{title:`Broadcast + Vote`,desc:`Send the same task to all agents, then use a majority vote or quality scoring to pick the best answer.`,code:`config.set_strategy(
  OrchestrationStrategy.broadcast()
)
config.set_merge_strategy(
  ParallelAggregation.majority()
)`},{title:`Retry Fallback`,desc:`Try agents in order. If one fails, the supervisor automatically moves to the next. Good for resilient pipelines.`,code:`config.set_strategy(
  OrchestrationStrategy.retry_fallback()
)`}].map(e=>(0,j.jsxs)(`div`,{style:{background:`#161b22`,border:`1px solid #21262d`,borderRadius:8,padding:`20px`},children:[(0,j.jsx)(`div`,{style:{fontWeight:600,color:`#e6edf3`,marginBottom:6},children:e.title}),(0,j.jsx)(`p`,{style:{color:`#8b949e`,fontSize:`0.875rem`,lineHeight:1.65,marginBottom:12},children:e.desc}),(0,j.jsx)(`pre`,{style:{background:`#0d1117`,border:`1px solid #30363d`,borderRadius:6,padding:`10px 12px`,fontSize:`0.75rem`,lineHeight:1.6,color:`#e6edf3`,margin:0,overflowX:`auto`},children:e.code})]},e.title))})}),(0,j.jsxs)(Bi,{id:`yaml`,title:`Config-Driven Supervisor (YAML)`,children:[(0,j.jsx)(`p`,{style:Wi,children:`For production deployments, define your multi-agent topology in YAML. This lets you iterate on agent composition without code changes.`}),(0,j.jsx)(N,{forceLang:`yaml`,rust:`name: research-pipeline
type: supervisor
...
result = pipeline.run()
print(result.get("formatted_report"))`}),(0,j.jsx)(Vi,{type:`tip`,title:`Nested supervisors`,children:`You can nest supervisors by making one child agent itself a supervisor config. This enables hierarchical team-of-teams architectures.`})]})]})}function Bi({id:e,title:t,children:n}){return(0,j.jsxs)(`section`,{id:e,style:{marginBottom:52},children:[(0,j.jsx)(`h2`,{style:{fontSize:`1.375rem`,fontWeight:600,color:`#e6edf3`,marginBottom:16,marginTop:0},children:t}),n]})}function Vi({type:e,title:t,children:n}){let r={info:{bg:`rgba(53,114,165,0.1)`,border:`rgba(53,114,165,0.4)`,text:`#58a6ff`},tip:{bg:`rgba(63,185,80,0.1)`,border:`rgba(63,185,80,0.4)`,text:`#3fb950`},warn:{bg:`rgba(210,153,34,0.1)`,border:`rgba(210,153,34,0.4)`,text:`#d29922`}},i=r[e]||r.info;return(0,j.jsxs)(`div`,{style:{background:i.bg,border:`1px solid ${i.border}`,borderRadius:8,padding:`14px 18px`,marginTop:16},children:[t&&(0,j.jsx)(`div`,{style:{fontWeight:600,color:i.text,marginBottom:6,fontSize:`0.9rem`},children:t}),(0,j.jsx)(`div`,{style:{color:`#8b949e`,fontSize:`0.875rem`,lineHeight:1.65},children:n})]})}var Hi={fontSize:`2rem`,fontWeight:700,color:`#e6edf3`,letterSpacing:`-0.02em`,marginBottom:8,marginTop:0},Ui={color:`#8b949e`,marginBottom:40,lineHeight:1.7,fontSize:`1.0625rem`},Wi={color:`#8b949e`,lineHeight:1.75,marginBottom:16},Gi={background:`#21262d`,border:`1px solid #30363d`,borderRadius:4,padding:`1px 6px`,fontSize:`0.85em`,fontFamily:`JetBrains Mono, monospace`},Ki=[{id:`overview`,label:`Overview`},{id:`init-tracing`,label:`Enable Tracing`},{id:`execution-tracer`,label:`ExecutionTracer`},{id:`visualization`,label:`Graph Visualization`},{id:`token-usage`,label:`Token Usage & Cost`},{id:`debugging`,label:`Debugging Tips`}];function qi(){return(0,j.jsxs)(P,{anchors:Ki,children:[(0,j.jsx)(`h1`,{style:Xi,children:`Observability & Tracing`}),(0,j.jsx)(`p`,{style:Zi,children:`Understand what your agent is doing, how long each node takes, and how much it costs. Flowgentra has built-in tracing, execution metrics, and graph visualization — no external tools required.`}),(0,j.jsxs)(Ji,{id:`overview`,title:`Overview`,children:[(0,j.jsx)(`p`,{style:Qi,children:`Flowgentra's observability stack includes:`}),(0,j.jsxs)(`ul`,{style:$i,children:[(0,j.jsxs)(`li`,{children:[(0,j.jsx)(`strong`,{style:{color:`#e6edf3`},children:`Structured logging`}),` — per-node span logs with timing`]}),(0,j.jsxs)(`li`,{children:[(0,j.jsx)(`strong`,{style:{color:`#e6edf3`},children:`ExecutionTracer`}),` — programmatic event capture and inspection`]}),(0,j.jsxs)(`li`,{children:[(0,j.jsx)(`strong`,{style:{color:`#e6edf3`},children:`Graph visualization`}),` — Mermaid flowcharts and Graphviz DOT export`]}),(0,j.jsxs)(`li`,{children:[(0,j.jsx)(`strong`,{style:{color:`#e6edf3`},children:`Token tracking`}),` — built into `,(0,j.jsx)(`code`,{style:ea,children:`LLMClient.chat_with_usage()`})]}),(0,j.jsxs)(`li`,{children:[(0,j.jsx)(`strong`,{style:{color:`#e6edf3`},children:`Cost estimation`}),` — per-model pricing via `,(0,j.jsx)(`code`,{style:ea,children:`TokenUsage.estimated_cost()`})]})]})]}),(0,j.jsxs)(Ji,{id:`init-tracing`,title:`Enable Tracing`,children:[(0,j.jsxs)(`p`,{style:Qi,children:[`Call `,(0,j.jsx)(`code`,{style:ea,children:`init_tracing()`}),` once at startup to enable structured span logging. All node starts, ends, and edge traversals will be logged automatically.`]}),(0,j.jsx)(N,{rust:`use flowgentra_ai::observability::init_tracing;
...
# [INFO] flowgentra::graph  edge        from=classify  to=technical  condition_met=true`})]}),(0,j.jsxs)(Ji,{id:`execution-tracer`,title:`ExecutionTracer — Programmatic Capture`,children:[(0,j.jsxs)(`p`,{style:Qi,children:[`For programmatic access to execution events (e.g., in tests or dashboards), use `,(0,j.jsx)(`code`,{style:ea,children:`ExecutionTracer`}),`. It captures every node execution, edge traversal, and state update.`]}),(0,j.jsx)(N,{rust:`use flowgentra_ai::observability::{ExecutionTracer, ExecutionTrace};
...
# Clear for next run
tracer.clear()`}),(0,j.jsxs)(`p`,{style:{...Qi,marginTop:16},children:[`The `,(0,j.jsx)(`code`,{style:ea,children:`ExecutionTrace`}),` class provides a higher-level summary:`]}),(0,j.jsx)(N,{rust:`let trace = ExecutionTrace::from_agent("my-agent");
...
json_str = trace.to_json()            # full JSON export`})]}),(0,j.jsxs)(Ji,{id:`visualization`,title:`Graph Visualization`,children:[(0,j.jsx)(`p`,{style:Qi,children:`Export your compiled graph as a Mermaid flowchart or Graphviz DOT diagram. Great for documentation and debugging routing logic.`}),(0,j.jsx)(N,{rust:`let graph = builder.build()?;
...
print(graph_dict["edges"])   # list of {from, to} dicts`}),(0,j.jsxs)(Yi,{type:`tip`,title:`Embed in Jupyter notebooks`,children:[`In a Jupyter notebook, render the Mermaid diagram inline:`,(0,j.jsx)(`pre`,{style:ta,children:`from IPython.display import display, HTML

mermaid = graph.to_mermaid()
display(HTML(f"""
<div class="mermaid">{mermaid}</div>
<script src="https://cdn.jsdelivr.net/npm/mermaid/dist/mermaid.min.js"><\/script>
"""))`})]})]}),(0,j.jsxs)(Ji,{id:`token-usage`,title:`Token Usage & Cost Estimation`,children:[(0,j.jsxs)(`p`,{style:Qi,children:[`Use `,(0,j.jsx)(`code`,{style:ea,children:`chat_with_usage()`}),` to get token counts alongside the response. Then estimate cost per-model with `,(0,j.jsx)(`code`,{style:ea,children:`TokenUsage.estimated_cost()`}),`.`]}),(0,j.jsx)(N,{rust:`let (response, usage) = client.chat_with_usage(messages).await?;
...
print(f"Quality score: {score:.2f}")`}];function da(){return(0,j.jsxs)(P,{anchors:ua.map(e=>({id:e.id,label:e.title})),children:[(0,j.jsx)(`h1`,{style:{fontSize:`2rem`,fontWeight:700,color:`#e6edf3`,letterSpacing:`-0.02em`,marginBottom:8,marginTop:0},children:`Examples`}),(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:48,lineHeight:1.7},children:`Real-world usage patterns. Toggle between Rust and Python using the language switcher.`}),ua.map((e,t)=>(0,j.jsxs)(`section`,{id:e.id,style:{marginBottom:60,paddingBottom:60,borderBottom:t<ua.length-1?`1px solid #21262d`:`none`},children:[(0,j.jsx)(`div`,{style:{display:`flex`,alignItems:`baseline`,gap:12,marginBottom:8},children:(0,j.jsxs)(`span`,{style:{fontSize:`0.75rem`,fontWeight:600,color:`var(--accent)`,background:`var(--accent-dim)`,border:`1px solid var(--accent)`,borderRadius:10,padding:`2px 10px`},children:[`Example `,t+1]})}),(0,j.jsx)(`h2`,{style:{fontSize:`1.375rem`,fontWeight:600,color:`#e6edf3`,marginBottom:8,marginTop:0},children:e.title}),(0,j.jsx)(`p`,{style:{color:`#8b949e`,lineHeight:1.7,marginBottom:20},children:e.description}),(0,j.jsx)(N,{rust:e.rust,python:e.python})]},e.id))]})}var fa=[{version:`0.1.3`,date:`2025-04-05`,tag:`latest`,changes:[{type:`fix`,text:"Python: all submodule imports now work correctly (use `from flowgentra_ai.graph import StateGraph`, not `from flowgentra import …`)"},{type:`fix`,text:"Python: `Agent.create()` now takes `model` string instead of `llm` LLMClient object; use `run_with_input(str)` on the returned agent"},{type:`fix`,text:"Python: `StateGraph.invoke()` accepts a plain `dict` — do not wrap with `State()`"},{type:`fix`,text:`Python: fixed 9 compile errors in PyO3 bindings (rayon, schema_version, tool extraction, GIL cloning, type mismatches)`},{type:`fix`,text:"Python: `conversation_memory.rs` extra brace syntax error resolved"},{type:`fix`,text:"Python: `LLMClient` constructor no longer requires a pre-built config object"},{type:`breaking`,text:'Python: `Agent.create(llm=…)` removed — pass `model="gpt-4o"` string instead'},{type:`breaking`,text:"Python: top-level `from flowgentra import StateGraph` removed — use submodule imports"},{type:`docs`,text:"Updated all code examples to use correct `flowgentra_ai.*` submodule import paths"}],rust:`# Cargo.toml
...
flowgentra = "0.4"`,python:`pip install "flowgentra==0.4.0"`},{version:`0.3.2`,date:`2024-10-15`,tag:null,changes:[{type:`fix`,text:"Python: handle `None` return values from node functions"},{type:`fix`,text:`Rust: correct borrow checker error with recursive graphs`},{type:`docs`,text:`Improve error messages for missing entry node`}],rust:`flowgentra = "0.3.2"`,python:`pip install "flowgentra==0.3.2"`},{version:`0.3.0`,date:`2024-09-01`,tag:null,changes:[{type:`feat`,text:`Initial Python bindings via PyO3`},{type:`feat`,text:`TypedDict state support in Python`},{type:`feat`,text:`Async node support in both languages`},{type:`breaking`,text:"Renamed `Graph::new` to `StateGraph::builder`"}],rust:`flowgentra = "0.3"`,python:`pip install "flowgentra==0.3.0"`}],pa={feat:{bg:`rgba(35,134,54,0.15)`,color:`#3fb950`,label:`feat`},fix:{bg:`rgba(248,81,73,0.15)`,color:`#f85149`,label:`fix`},perf:{bg:`rgba(53,114,165,0.15)`,color:`#79c0ff`,label:`perf`},docs:{bg:`rgba(139,148,158,0.15)`,color:`#8b949e`,label:`docs`},breaking:{bg:`rgba(210,153,34,0.15)`,color:`#e3b341`,label:`breaking`}};function ma(){return(0,j.jsxs)(P,{children:[(0,j.jsx)(`h1`,{style:{fontSize:`2rem`,fontWeight:700,color:`#e6edf3`,letterSpacing:`-0.02em`,marginBottom:8,marginTop:0},children:`Changelog`}),(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:48,lineHeight:1.7},children:`All notable changes to Flowgentra. The language switcher shows the install snippet for each version.`}),fa.map((e,t)=>(0,j.jsxs)(`article`,{style:{marginBottom:52,paddingBottom:52,borderBottom:t<fa.length-1?`1px solid #21262d`:`none`},children:[(0,j.jsxs)(`div`,{style:{display:`flex`,flexWrap:`wrap`,alignItems:`center`,gap:10,marginBottom:6},children:[(0,j.jsxs)(`h2`,{style:{fontFamily:`JetBrains Mono, monospace`,fontSize:`1.25rem`,color:`#e6edf3`,margin:0},children:[`v`,e.version]}),e.tag&&(0,j.jsx)(`span`,{style:{background:`rgba(35,134,54,0.15)`,color:`#3fb950`,border:`1px solid rgba(35,134,54,0.4)`,borderRadius:10,fontSize:`0.75rem`,padding:`2px 10px`,fontWeight:500},children:e.tag}),(0,j.jsx)(`span`,{style:{color:`#484f58`,fontSize:`0.875rem`,marginLeft:`auto`},children:e.date})]}),(0,j.jsx)(`ul`,{style:{listStyle:`none`,padding:0,margin:`16px 0 20px`},children:e.changes.map((t,n)=>{let r=pa[t.type]||pa.docs;return(0,j.jsxs)(`li`,{style:{display:`flex`,alignItems:`baseline`,gap:10,padding:`6px 0`,borderBottom:n<e.changes.length-1?`1px solid #161b22`:`none`},children:[(0,j.jsx)(`span`,{style:{background:r.bg,color:r.color,fontSize:`0.7rem`,fontWeight:600,padding:`2px 7px`,borderRadius:4,flexShrink:0,fontFamily:`JetBrains Mono, monospace`},children:r.label}),(0,j.jsx)(`span`,{style:{color:`#c9d1d9`,lineHeight:1.6,fontSize:`0.9375rem`},children:t.text})]},n)})}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`p`,{style:{fontSize:`0.8125rem`,color:`#8b949e`,marginBottom:8},children:`Install this version:`}),(0,j.jsx)(N,{rust:e.rust,python:e.python})]})]},e.version))]})}function ha(){return(0,j.jsx)(Xn,{children:(0,j.jsx)(On,{basename:`/flowgentra-ai-docs`,children:(0,j.jsxs)(`div`,{style:{minHeight:`100vh`,display:`flex`,flexDirection:`column`},children:[(0,j.jsx)($n,{}),(0,j.jsx)(`div`,{style:{flex:1},children:(0,j.jsxs)(Bt,{children:[(0,j.jsx)(k,{path:`/`,element:(0,j.jsx)(sr,{})}),(0,j.jsx)(k,{path:`/docs/getting-started`,element:(0,j.jsx)(dr,{})}),(0,j.jsx)(k,{path:`/docs/quickstart-rust`,element:(0,j.jsx)(vr,{})}),(0,j.jsx)(k,{path:`/docs/quickstart-python`,element:(0,j.jsx)(Or,{})}),(0,j.jsx)(k,{path:`/docs/installation`,element:(0,j.jsx)(Rr,{})}),(0,j.jsx)(k,{path:`/docs/what-is-flowgentra`,element:(0,j.jsx)(Vr,{})}),(0,j.jsx)(k,{path:`/docs/concepts/state`,element:(0,j.jsx)(Xr,{})}),(0,j.jsx)(k,{path:`/docs/concepts/graphs`,element:(0,j.jsx)(Wr,{})}),(0,j.jsx)(k,{path:`/docs/concepts/nodes`,element:(0,j.jsx)(qr,{})}),(0,j.jsx)(k,{path:`/docs/guides/agents`,element:(0,j.jsx)(ai,{})}),(0,j.jsx)(k,{path:`/docs/guides/llm-client`,element:(0,j.jsx)(ci,{})}),(0,j.jsx)(k,{path:`/docs/guides/tools`,element:(0,j.jsx)(bi,{})}),(0,j.jsx)(k,{path:`/docs/guides/memory`,element:(0,j.jsx)(di,{})}),(0,j.jsx)(k,{path:`/docs/guides/rag`,element:(0,j.jsx)(_i,{})}),(0,j.jsx)(k,{path:`/docs/guides/document-loaders`,element:(0,j.jsx)(ki,{})}),(0,j.jsx)(k,{path:`/docs/guides/supervisor`,element:(0,j.jsx)(zi,{})}),(0,j.jsx)(k,{path:`/docs/guides/human-in-loop`,element:(0,j.jsx)(mi,{})}),(0,j.jsx)(k,{path:`/docs/guides/error-handling`,element:(0,j.jsx)(Ci,{})}),(0,j.jsx)(k,{path:`/docs/guides/evaluation`,element:(0,j.jsx)(Fi,{})}),(0,j.jsx)(k,{path:`/docs/guides/observability`,element:(0,j.jsx)(qi,{})}),(0,j.jsx)(k,{path:`/docs/guides/advanced-nodes`,element:(0,j.jsx)(F,{})}),(0,j.jsx)(k,{path:`/docs/guides/reranking`,element:(0,j.jsx)(Mi,{})}),(0,j.jsx)(k,{path:`/docs/guides/configuration`,element:(0,j.jsx)(Ei,{})}),(0,j.jsx)(k,{path:`/docs/api/:topicId`,element:(0,j.jsx)(la,{})}),(0,j.jsx)(k,{path:`/docs/examples`,element:(0,j.jsx)(da,{})}),(0,j.jsx)(k,{path:`/docs/best-practices`,element:(0,j.jsx)(ra,{})}),(0,j.jsx)(k,{path:`/docs/faq`,element:(0,j.jsx)(aa,{})}),(0,j.jsx)(k,{path:`/docs/changelog`,element:(0,j.jsx)(ma,{})}),(0,j.jsx)(k,{path:`/docs/api-reference`,element:(0,j.jsx)(Rt,{to:`/docs/api/state-graph`,replace:!0})}),(0,j.jsx)(k,{path:`/docs`,element:(0,j.jsx)(Rt,{to:`/docs/getting-started`,replace:!0})}),(0,j.jsx)(k,{path:`*`,element:(0,j.jsx)(Rt,{to:`/`,replace:!0})})]})})]})})})}(0,y.createRoot)(document.getElementById(`root`)).render((0,j.jsx)(v.StrictMode,{children:(0,j.jsx)(ha,{})}));export{s as n,S as t};