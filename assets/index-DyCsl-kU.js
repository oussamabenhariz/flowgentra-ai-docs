...
print(result["output"])
# Hello from Flowgentra!`,ir=[{icon:`⚡`,title:`Blazing Fast`,description:`Zero-cost abstractions in Rust. Python bindings with near-native performance via PyO3. Async-first throughout.`},{icon:`🔒`,title:`Type Safe`,description:`Rust's compile-time state guarantees. Python TypedDicts for runtime validation. Catch graph errors before they run.`},{icon:`🔀`,title:`Dual Language`,description:`Write your agent logic in Rust or Python — or mix them. Share YAML configs across both runtimes.`}];function ar({onChoose:e}){let[t,n]=(0,v.useState)(null),r=(r,i,a,o,s)=>{let c=t===r;return(0,j.jsxs)(`button`,{onClick:()=>e(r),onMouseEnter:()=>n(r),onMouseLeave:()=>n(null),style:{background:`#161b22`,border:`2px solid ${c?s:`#21262d`}`,borderRadius:14,padding:`40px 52px`,cursor:`pointer`,display:`flex`,flexDirection:`column`,alignItems:`center`,gap:14,width:240,transform:c?`translateY(-4px) scale(1.02)`:`none`,transition:`border-color 0.2s, transform 0.18s, box-shadow 0.2s`,boxShadow:c?`0 8px 32px ${s}33`:`none`},children:[(0,j.jsx)(`span`,{style:{fontSize:`3.5rem`,lineHeight:1},children:i}),(0,j.jsx)(`span`,{style:{fontSize:`1.375rem`,fontWeight:700,color:`#e6edf3`},children:a}),(0,j.jsx)(`span`,{style:{fontSize:`0.875rem`,color:`#8b949e`,textAlign:`center`,lineHeight:1.5},children:o}),(0,j.jsx)(`span`,{style:{marginTop:4,background:s,color:`#fff`,fontSize:`0.8125rem`,fontWeight:600,padding:`5px 18px`,borderRadius:20},children:`Choose →`})]})};return(0,j.jsxs)(`div`,{style:{minHeight:`calc(100vh - 60px)`,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,padding:`40px 24px`,gap:48},children:[(0,j.jsxs)(`div`,{style:{textAlign:`center`,maxWidth:560},children:[(0,j.jsx)(`h1`,{style:{fontSize:`clamp(1.75rem, 4vw, 2.75rem)`,fontWeight:700,color:`#e6edf3`,marginBottom:16,marginTop:0,letterSpacing:`-0.03em`},children:`Which language are you using?`}),(0,j.jsx)(`p`,{style:{color:`#8b949e`,fontSize:`1.0625rem`,lineHeight:1.7,margin:0},children:`We'll theme the entire site and show you the right API signatures and code examples. You can always switch from the navbar.`})]}),(0,j.jsxs)(`div`,{style:{display:`flex`,gap:28,flexWrap:`wrap`,justifyContent:`center`},children:[r(`rust`,`🦀`,`Rust`,`Type-safe, zero-cost, async-first`,`#CE422B`),r(`python`,`🐍`,`Python`,`Ergonomic, LangGraph-compatible`,`#3572A5`)]})]})}function or(){let{language:e,setLanguage:t}=M(),n=e===`rust`,[r,i]=(0,v.useState)(()=>localStorage.getItem(`fg-lang-chosen`)===`true`);return r?(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`section`,{style:{background:`linear-gradient(180deg, #161b22 0%, #0d1117 100%)`,borderBottom:`1px solid #21262d`},children:(0,j.jsx)(`div`,{style:{maxWidth:1100,margin:`0 auto`,padding:`80px 24px 60px`},children:(0,j.jsxs)(`div`,{style:{display:`flex`,flexWrap:`wrap`,gap:48,alignItems:`center`},children:[(0,j.jsxs)(`div`,{style:{flex:`1 1 360px`,minWidth:0},children:[(0,j.jsxs)(`div`,{style:{display:`inline-flex`,alignItems:`center`,gap:8,background:`var(--accent-dim)`,border:`1px solid var(--accent)`,borderRadius:20,padding:`4px 12px`,fontSize:`0.8125rem`,color:`var(--accent)`,marginBottom:20,transition:`all 0.2s`},children:[(0,j.jsx)(`span`,{children:n?`🦀`:`🐍`}),n?`Built in Rust`:`Python native`]}),(0,j.jsxs)(`h1`,{style:{fontSize:`clamp(2rem, 5vw, 3.25rem)`,fontWeight:700,lineHeight:1.15,letterSpacing:`-0.03em`,color:`#e6edf3`,marginBottom:20,marginTop:0},children:[`Agent graphs for`,(0,j.jsx)(`br`,{}),(0,j.jsx)(`span`,{style:{color:`var(--accent)`,transition:`color 0.3s`},children:n?`Rust & Python`:`Python & Rust`})]}),(0,j.jsx)(`p`,{style:{fontSize:`1.1rem`,color:`#8b949e`,lineHeight:1.7,marginBottom:32,maxWidth:460},children:`Flowgentra lets you build stateful, multi-step AI agents as typed graphs. Define nodes, wire edges, and invoke — in Rust or Python.`}),(0,j.jsxs)(`div`,{style:{display:`flex`,flexWrap:`wrap`,gap:12,marginBottom:32},children:[(0,j.jsx)(An,{to:`/docs/getting-started`,style:{background:`var(--accent)`,color:`#fff`,padding:`10px 24px`,borderRadius:6,textDecoration:`none`,fontWeight:600,fontSize:`0.9375rem`,transition:`opacity 0.15s`},onMouseEnter:e=>e.target.style.opacity=`0.85`,onMouseLeave:e=>e.target.style.opacity=`1`,children:`Get Started →`}),(0,j.jsx)(An,{to:`/docs/api-reference`,style:{background:`transparent`,color:`#e6edf3`,padding:`10px 24px`,borderRadius:6,textDecoration:`none`,fontWeight:500,fontSize:`0.9375rem`,border:`1px solid #30363d`,transition:`border-color 0.15s`},onMouseEnter:e=>e.target.style.borderColor=`var(--accent)`,onMouseLeave:e=>e.target.style.borderColor=`#30363d`,children:`API Reference`})]}),(0,j.jsx)(Zn,{})]}),(0,j.jsx)(`div`,{style:{flex:`1 1 440px`,minWidth:0},children:(0,j.jsx)(N,{rust:nr,python:rr})})]})})}),(0,j.jsxs)(`section`,{style:{maxWidth:1100,margin:`0 auto`,padding:`72px 24px`},children:[(0,j.jsx)(`h2`,{style:{textAlign:`center`,fontSize:`1.75rem`,fontWeight:700,color:`#e6edf3`,letterSpacing:`-0.02em`,marginBottom:12,marginTop:0},children:`Why Flowgentra?`}),(0,j.jsx)(`p`,{style:{textAlign:`center`,color:`#8b949e`,marginBottom:48},children:`Production-ready agent infrastructure — without the boilerplate.`}),(0,j.jsx)(`div`,{style:{display:`grid`,gridTemplateColumns:`repeat(auto-fit, minmax(280px, 1fr))`,gap:20},children:ir.map(e=>(0,j.jsxs)(`div`,{style:{background:`#161b22`,border:`1px solid #21262d`,borderRadius:10,padding:`28px 28px`,transition:`border-color 0.2s`},onMouseEnter:e=>e.currentTarget.style.borderColor=`var(--accent)`,onMouseLeave:e=>e.currentTarget.style.borderColor=`#21262d`,children:[(0,j.jsx)(`div`,{style:{fontSize:`2rem`,marginBottom:12},children:e.icon}),(0,j.jsx)(`h3`,{style:{fontSize:`1.1rem`,fontWeight:600,color:`#e6edf3`,marginBottom:8,marginTop:0},children:e.title}),(0,j.jsx)(`p`,{style:{color:`#8b949e`,lineHeight:1.7,margin:0,fontSize:`0.9375rem`},children:e.description})]},e.title))})]}),(0,j.jsx)(`section`,{style:{background:`#161b22`,borderTop:`1px solid #21262d`,borderBottom:`1px solid #21262d`},children:(0,j.jsxs)(`div`,{style:{maxWidth:700,margin:`0 auto`,padding:`64px 24px`,textAlign:`center`},children:[(0,j.jsx)(`h2`,{style:{fontSize:`1.75rem`,fontWeight:700,color:`#e6edf3`,marginBottom:12,marginTop:0},children:`Ready to build?`}),(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:28},children:`Start with our quickstart guide and ship your first agent in minutes.`}),(0,j.jsx)(An,{to:`/docs/getting-started`,style:{background:`var(--accent)`,color:`#fff`,padding:`12px 32px`,borderRadius:6,textDecoration:`none`,fontWeight:600,fontSize:`1rem`,display:`inline-block`,transition:`opacity 0.15s`},onMouseEnter:e=>e.target.style.opacity=`0.85`,onMouseLeave:e=>e.target.style.opacity=`1`,children:`Get Started`})]})}),(0,j.jsxs)(`footer`,{style:{maxWidth:1100,margin:`0 auto`,padding:`32px 24px`,display:`flex`,flexWrap:`wrap`,gap:16,alignItems:`center`,justifyContent:`space-between`,borderTop:`1px solid #21262d`},children:[(0,j.jsx)(`span`,{style:{color:`#484f58`,fontSize:`0.875rem`},children:`© 2024 flowgentra`}),(0,j.jsx)(`div`,{style:{display:`flex`,gap:24},children:[[`GitHub`,`https://github.com`],[`crates.io`,`https://crates.io`],[`PyPI`,`https://pypi.org`]].map(([e,t])=>(0,j.jsx)(`a`,{href:t,target:`_blank`,rel:`noopener noreferrer`,style:{color:`#8b949e`,textDecoration:`none`,fontSize:`0.875rem`,transition:`color 0.15s`},onMouseEnter:e=>e.target.style.color=`var(--accent)`,onMouseLeave:e=>e.target.style.color=`#8b949e`,children:e},e))})]})]}):(0,j.jsx)(ar,{onChoose:e=>{t(e),localStorage.setItem(`fg-lang-chosen`,`true`),i(!0)}})}var sr=[{group:`Introduction`,links:[{to:`/docs/getting-started`,label:`Getting Started`},{to:`/docs/installation`,label:`Installation`},{to:`/docs/what-is-flowgentra`,label:`What is Flowgentra?`}]},{group:`Core Concepts`,links:[{to:`/docs/concepts/graphs`,label:`Graphs`},{to:`/docs/concepts/nodes`,label:`Nodes`},{to:`/docs/concepts/state`,label:`State`}]},{group:`Guides`,links:[{to:`/docs/guides/agents`,label:`Building Agents`},{to:`/docs/guides/llm-client`,label:`LLM Integration`},{to:`/docs/guides/memory`,label:`Memory Management`},{to:`/docs/guides/human-in-loop`,label:`Human-in-the-Loop`},{to:`/docs/guides/rag`,label:`RAG Implementation`},{to:`/docs/guides/tools`,label:`Tool Integration`},{to:`/docs/guides/error-handling`,label:`Error Handling`},{to:`/docs/guides/configuration`,label:`Configuration`}]},{group:`API Reference`,links:[{to:`/docs/api/state-graph`,label:`StateGraph`},{to:`/docs/api/handlers-config`,label:`Handlers & Config`},{to:`/docs/api/memory`,label:`Memory`},{to:`/docs/api/builtin-nodes`,label:`Built-in Nodes`},{to:`/docs/api/agents`,label:`Agents`},{to:`/docs/api/llm`,label:`LLM Clients`},{to:`/docs/api/rag`,label:`RAG`},{to:`/docs/api/supervisor`,label:`Supervisor`},{to:`/docs/api/observability`,label:`Observability`}]},{group:`More`,links:[{to:`/docs/examples`,label:`Examples`},{to:`/docs/best-practices`,label:`Best Practices`},{to:`/docs/faq`,label:`FAQ`},{to:`/docs/changelog`,label:`Changelog`}]}];function P({children:e,anchors:t=[]}){let[n,r]=(0,v.useState)(!1),i=({isActive:e})=>({display:`block`,padding:`5px 12px`,borderRadius:4,fontSize:`0.875rem`,color:e?`var(--accent)`:`#8b949e`,background:e?`var(--accent-dim, rgba(206,66,43,0.1))`:`transparent`,textDecoration:`none`,fontWeight:e?500:400,transition:`color 0.15s, background 0.15s`}),a=()=>(0,j.jsxs)(`aside`,{style:{width:220,flexShrink:0,borderRight:`1px solid #21262d`,padding:`32px 0`,display:`flex`,flexDirection:`column`,gap:`28px`},children:[sr.map(e=>(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`div`,{style:{fontSize:`0.7rem`,fontWeight:600,color:`#484f58`,textTransform:`uppercase`,letterSpacing:`0.08em`,padding:`0 12px`,marginBottom:8},children:e.group}),e.links.map(e=>(0,j.jsx)(jn,{to:e.to,style:i,children:e.label},e.to))]},e.group)),t.length>0&&(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`div`,{style:{fontSize:`0.7rem`,fontWeight:600,color:`#484f58`,textTransform:`uppercase`,letterSpacing:`0.08em`,padding:`0 12px`,marginBottom:8},children:`On this page`}),t.map(e=>(0,j.jsx)(`a`,{href:`#${e.id}`,style:{display:`block`,padding:`4px 12px`,fontSize:`0.8125rem`,color:`#8b949e`,textDecoration:`none`,transition:`color 0.15s`},onMouseEnter:e=>e.target.style.color=`var(--accent)`,onMouseLeave:e=>e.target.style.color=`#8b949e`,children:e.label},e.id))]})]});return(0,j.jsxs)(`div`,{style:{maxWidth:1280,margin:`0 auto`,padding:`0 24px`,display:`flex`,minHeight:`calc(100vh - 60px)`},children:[(0,j.jsx)(`div`,{className:`doc-sidebar-desktop`,children:(0,j.jsx)(a,{})}),n&&(0,j.jsxs)(`div`,{style:{position:`fixed`,inset:0,zIndex:40,display:`flex`},children:[(0,j.jsx)(`div`,{style:{background:`rgba(0,0,0,0.6)`,position:`absolute`,inset:0},onClick:()=>r(!1)}),(0,j.jsxs)(`div`,{style:{position:`relative`,background:`#0d1117`,width:260,height:`100%`,padding:`20px 0`,overflowY:`auto`,borderRight:`1px solid #21262d`,zIndex:1},children:[(0,j.jsx)(`button`,{onClick:()=>r(!1),style:{background:`none`,border:`none`,color:`#8b949e`,cursor:`pointer`,padding:`0 16px`,marginBottom:16},children:`✕ Close`}),(0,j.jsx)(a,{})]})]}),(0,j.jsxs)(`main`,{style:{flex:1,padding:`40px 0 80px 48px`,minWidth:0},children:[(0,j.jsx)(`button`,{onClick:()=>r(!0),className:`doc-mobile-toggle`,style:{display:`none`,marginBottom:24,background:`#161b22`,border:`1px solid #30363d`,borderRadius:6,color:`#e6edf3`,cursor:`pointer`,padding:`8px 16px`,fontSize:`0.875rem`},children:`☰ Menu`}),e]}),(0,j.jsx)(`style`,{children:`
        @media (max-width: 768px) {
          .doc-sidebar-desktop { display: none; }
          .doc-mobile-toggle { display: flex !important; }
          main { padding-left: 0 !important; }
        }
      `})]})}var cr=[{id:`overview`,label:`Overview`},{id:`quick-start`,label:`Quick Start`},{id:`two-patterns`,label:`Two Patterns`},{id:`next-steps`,label:`Next Steps`}];function lr(){let{language:e}=M(),t=e===`rust`;return(0,j.jsxs)(P,{anchors:cr,children:[(0,j.jsx)(`h1`,{style:{fontSize:`2rem`,fontWeight:700,color:`#e6edf3`,letterSpacing:`-0.02em`,marginBottom:8,marginTop:0},children:`Getting Started`}),(0,j.jsxs)(`p`,{style:{color:`#8b949e`,marginBottom:40,lineHeight:1.7},children:[`Build your first Flowgentra agent in `,t?`Rust`:`Python`,` in 5 minutes.`]}),(0,j.jsx)(ur,{id:`overview`,title:`Overview`,children:(0,j.jsxs)(`p`,{style:{color:`#8b949e`,lineHeight:1.75,margin:0},children:[`Flowgentra models your AI agent as a `,(0,j.jsx)(`strong`,{style:{color:`#e6edf3`},children:`directed graph`}),`. Each node is a function that reads and writes shared state. Edges define execution order. Conditional edges allow dynamic branching. The compiled graph runs synchronously or asynchronously, returning final state.`]})}),(0,j.jsxs)(ur,{id:`quick-start`,title:`Quick Start`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:t?`Add flowgentra to your Cargo.toml, then:`:`Install flowgentra, then:`}),(0,j.jsx)(N,{rust:`use flowgentra::prelude::*;
...
# Hello, world! 👋`})]}),(0,j.jsxs)(ur,{id:`two-patterns`,title:`Two Patterns`,children:[(0,j.jsxs)(`p`,{style:{color:`#8b949e`,lineHeight:1.75,marginBottom:24},children:[`Flowgentra supports two complementary ways to build agents. Both work in `,t?`Rust`:`Python`,`.`]}),(0,j.jsx)(dr,{number:`1`,title:`Code-Driven`,badge:`Good for: scripts, prototypes`,description:`Define the graph entirely in code. Best for small agents where the graph topology is fixed.`,children:(0,j.jsx)(N,{rust:`// All wiring in code
let graph = StateGraph::<MyState>::builder()
    .add_node("a", node_a)
    .add_node("b", node_b)
    .add_edge("a", "b")
    .set_entry("a")
    .build()?;`,python:`# All wiring in code
builder = StateGraph(MyState)
builder.add_node("a", node_a)
builder.add_node("b", node_b)
builder.add_edge("a", "b")
builder.set_entry_point("a")
graph = builder.compile()`})}),(0,j.jsx)(dr,{number:`2`,title:`Config-Driven`,badge:`Recommended for production`,description:`Define topology in YAML, handlers in code with @register_handler. Swap configs without recompiling.`,children:(0,j.jsx)(N,{rust:`// agent.yaml defines the graph
...
})).await?;`,python:`# agent.yaml defines the graph
# handlers discovered via @register_handler
agent = Agent.from_config_path("agent.yaml")
result = await agent.invoke({
    "query": "tell me about Python"
})`})})]}),(0,j.jsx)(ur,{id:`next-steps`,title:`Next Steps`,children:(0,j.jsx)(`div`,{style:{display:`grid`,gridTemplateColumns:`repeat(auto-fit, minmax(200px, 1fr))`,gap:12},children:[{to:`/docs/installation`,label:`📦 Installation`,desc:`Add to your project`},{to:`/docs/api-reference`,label:`📖 API Reference`,desc:`Full API docs`},{to:`/docs/examples`,label:`💡 Examples`,desc:`Real-world patterns`}].map(e=>(0,j.jsxs)(An,{to:e.to,style:{background:`#161b22`,border:`1px solid #21262d`,borderRadius:8,padding:`16px 18px`,textDecoration:`none`,display:`block`,transition:`border-color 0.2s`},onMouseEnter:e=>e.currentTarget.style.borderColor=`var(--accent)`,onMouseLeave:e=>e.currentTarget.style.borderColor=`#21262d`,children:[(0,j.jsx)(`div`,{style:{fontWeight:600,color:`#e6edf3`,marginBottom:4},children:e.label}),(0,j.jsx)(`div`,{style:{fontSize:`0.875rem`,color:`#8b949e`},children:e.desc})]},e.to))})})]})}function ur({id:e,title:t,children:n}){return(0,j.jsxs)(`section`,{id:e,style:{marginBottom:52},children:[(0,j.jsx)(`h2`,{style:{fontSize:`1.375rem`,fontWeight:600,color:`#e6edf3`,marginBottom:16,marginTop:0},children:t}),n]})}function dr({number:e,title:t,badge:n,description:r,children:i}){return(0,j.jsxs)(`div`,{style:{background:`#161b22`,border:`1px solid #21262d`,borderRadius:8,padding:`20px`,marginBottom:16},children:[(0,j.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:10,marginBottom:8},children:[(0,j.jsx)(`span`,{style:{background:`var(--accent)`,color:`#fff`,width:22,height:22,borderRadius:`50%`,display:`flex`,alignItems:`center`,justifyContent:`center`,fontSize:`0.75rem`,fontWeight:700,flexShrink:0},children:e}),(0,j.jsx)(`strong`,{style:{color:`#e6edf3`,fontSize:`1rem`},children:t}),(0,j.jsx)(`span`,{style:{background:`var(--accent-dim)`,color:`var(--accent)`,fontSize:`0.7rem`,padding:`2px 8px`,borderRadius:10,border:`1px solid var(--accent)`,fontWeight:500,marginLeft:`auto`},children:n})]}),(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:14,lineHeight:1.6,fontSize:`0.9rem`},children:r}),i]})}function fr(){let{language:e}=M();return(0,j.jsxs)(P,{children:[(0,j.jsx)(`h1`,{style:{fontSize:`2rem`,fontWeight:700,color:`#e6edf3`,letterSpacing:`-0.02em`,marginBottom:8,marginTop:0},children:`Installation`}),(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:40,lineHeight:1.7},children:`Get Flowgentra added to your project in under a minute.`}),e===`rust`?(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(pr,{title:`Cargo (Rust)`,subtitle:`Add to your Cargo.toml:`,children:(0,j.jsx)(N,{forceLang:`toml`,rust:`[dependencies]
flowgentra = "0.4"
tokio = { version = "1", features = ["full"] }`})}),(0,j.jsx)(pr,{title:`Feature Flags`,subtitle:`Enable optional features:`,children:(0,j.jsx)(N,{forceLang:`toml`,rust:`[dependencies]
...
]}`})}),(0,j.jsx)(pr,{title:`Requirements`,children:(0,j.jsxs)(`ul`,{style:{color:`#8b949e`,lineHeight:2,paddingLeft:20},children:[(0,j.jsxs)(`li`,{children:[`Rust `,(0,j.jsx)(`strong`,{style:{color:`#e6edf3`},children:`1.75+`})]}),(0,j.jsx)(`li`,{children:`Tokio async runtime`}),(0,j.jsx)(`li`,{children:`Cargo 1.75+`})]})}),(0,j.jsx)(pr,{title:`Verify`,children:(0,j.jsx)(N,{forceLang:`bash`,rust:`cargo add flowgentra
cargo build`})})]}):(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(pr,{title:`pip (Python)`,subtitle:`Install from PyPI:`,children:(0,j.jsx)(N,{forceLang:`bash`,python:`pip install flowgentra-ai`})}),(0,j.jsx)(pr,{title:`With extras`,children:(0,j.jsx)(N,{forceLang:`bash`,python:`# Include all optional integrations
pip install "flowgentra-ai[all]"

# Or individually
pip install "flowgentra-ai[openai]"
pip install "flowgentra-ai[anthropic]"
pip install "flowgentra-ai[tracing]"`})}),(0,j.jsx)(pr,{title:`Requirements`,children:(0,j.jsxs)(`ul`,{style:{color:`#8b949e`,lineHeight:2,paddingLeft:20},children:[(0,j.jsxs)(`li`,{children:[`Python `,(0,j.jsx)(`strong`,{style:{color:`#e6edf3`},children:`3.10+`})]}),(0,j.jsx)(`li`,{children:`Works in both sync and async contexts`})]})}),(0,j.jsx)(pr,{title:`Verify`,children:(0,j.jsx)(N,{forceLang:`bash`,python:`python -c "import flowgentra_ai; print(flowgentra_ai.__version__)"`})}),(0,j.jsx)(pr,{title:`Virtual environment (recommended)`,children:(0,j.jsx)(N,{forceLang:`bash`,python:`python -m venv .venv
source .venv/bin/activate  # Windows: .venv\\Scripts\\activate
pip install flowgentra-ai`})}),(0,j.jsxs)(pr,{title:`Import style`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:12,fontSize:`0.9375rem`},children:`Import from the appropriate submodule — not from the top-level package:`}),(0,j.jsx)(N,{forceLang:`bash`,python:`# Correct — submodule imports
...
from flowgentra_ai.observability import ExecutionTracer`})]})]})]})}function pr({title:e,subtitle:t,children:n}){return(0,j.jsxs)(`div`,{style:{marginBottom:40},children:[(0,j.jsx)(`h2`,{style:{fontSize:`1.25rem`,fontWeight:600,color:`#e6edf3`,marginBottom:t?6:14,marginTop:0},children:e}),t&&(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:12},children:t}),n]})}var mr=[{id:`overview`,label:`Overview`},{id:`mental-model`,label:`Mental Model`},{id:`core-primitives`,label:`Core Primitives`},{id:`engine-features`,label:`Engine Features`},{id:`two-patterns`,label:`Two Patterns`},{id:`languages`,label:`Languages`},{id:`next-steps`,label:`Next Steps`}];function hr(){let{language:e}=M();return(0,j.jsxs)(P,{anchors:mr,children:[(0,j.jsx)(`h1`,{style:{fontSize:`2rem`,fontWeight:700,color:`#e6edf3`,letterSpacing:`-0.02em`,marginBottom:8,marginTop:0},children:`What is Flowgentra?`}),(0,j.jsxs)(`p`,{style:{color:`#8b949e`,marginBottom:40,lineHeight:1.7},children:[`Flowgentra is a framework for building `,(0,j.jsx)(`strong`,{style:{color:`#e6edf3`},children:`AI agent workflows`}),`. It gives you the building blocks to create anything from a simple LLM-powered function to a complex multi-agent system with memory, tools, evaluation, and observability.`]}),(0,j.jsx)(gr,{id:`overview`,title:`Overview`,children:(0,j.jsxs)(`p`,{style:{color:`#8b949e`,lineHeight:1.75,margin:0},children:[`The core idea is simple: your agent logic is a `,(0,j.jsx)(`strong`,{style:{color:`#e6edf3`},children:`graph`}),`. Nodes are functions. Edges connect them. State flows through.`]})}),(0,j.jsxs)(gr,{id:`mental-model`,title:`The Mental Model`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Think of your agent as a flowchart:`}),(0,j.jsx)(`div`,{style:{background:`#0d1117`,border:`1px solid #21262d`,borderRadius:8,padding:`20px`,marginBottom:20,fontFamily:`monospace`,fontSize:`0.9rem`,color:`#8b949e`,textAlign:`center`},children:`          ┌─────────────┐
Input ───►│  Classify   │
          └──────┬──────┘
                 │
        ┌────────┴────────┐
...
# Run
result = graph.invoke(State({"input": "hello"}))`})}),(0,j.jsxs)(yr,{id:`conditional-routing`,title:`Conditional Routing`,children:[(0,j.jsxs)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:[`When you need different nodes to run based on state, use a `,(0,j.jsx)(`strong`,{style:{color:`#e6edf3`},children:`conditional edge`}),`. Your router function receives the current state and returns the name of the next node.`]}),(0,j.jsx)(N,{rust:`.conditional_edge("evaluate", |state: &DynState| {
...
# on_timeout="skip" returns the original state unchanged`})]})]})}function yr({id:e,title:t,children:n}){return(0,j.jsxs)(`section`,{id:e,style:{marginBottom:48},children:[(0,j.jsx)(`h2`,{style:{fontSize:`1.5rem`,fontWeight:600,color:`#e6edf3`,marginBottom:16,marginTop:0},children:t}),n]})}var br=[{id:`node-contract`,label:`The Node Contract`},{id:`node-types`,label:`Node Types`}];function xr(){let{language:e}=M();return(0,j.jsxs)(P,{anchors:br,children:[(0,j.jsx)(`h1`,{style:{fontSize:`2rem`,fontWeight:700,color:`#e6edf3`,letterSpacing:`-0.02em`,marginBottom:8,marginTop:0},children:`Nodes`}),(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:40,lineHeight:1.7},children:`A node is the fundamental unit of work in a Flowgentra graph. It's just a function.`}),(0,j.jsxs)(Sr,{id:`node-contract`,title:`The Node Contract`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Every node must:`}),(0,j.jsxs)(`ol`,{style:{color:`#8b949e`,lineHeight:1.7,paddingLeft:20,marginBottom:16},children:[(0,j.jsxs)(`li`,{children:[`Accept a single `,(0,j.jsx)(`code`,{style:{background:`#161b22`,padding:`2px 6px`,borderRadius:3,fontSize:`0.9em`},children:`State`}),` argument (Python) or `,(0,j.jsx)(`code`,{style:{background:`#161b22`,padding:`2px 6px`,borderRadius:3,fontSize:`0.9em`},children:`DynState`}),` / your typed state (Rust)`]}),(0,j.jsxs)(`li`,{children:[`Return a `,(0,j.jsx)(`code`,{style:{background:`#161b22`,padding:`2px 6px`,borderRadius:3,fontSize:`0.9em`},children:`State`}),` (usually the same object, modified)`]})]}),(0,j.jsx)(N,{rust:`async fn my_node(mut state: DynState) -> Result<DynState> {
    let input = state.get_string("input").unwrap_or_default();
    let result = process(&input).await?;
    state.set("output", result);
    Ok(state)
...
state.remove("score");`,python:`from flowgentra_ai import State
...
# Iterate
state.keys()            # ["user"]
len(state)              # 1`})}),(0,j.jsx)(Tr,{id:`creating`,title:`Creating State`,children:(0,j.jsx)(N,{rust:`// Empty
...
agent = (
    ...
    .build_graph()
)`})]}),(0,j.jsxs)(Or,{id:`conversational`,title:`Conversational`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`A conversational agent that maintains context across multiple turns. Perfect for chatbots and interactive assistants.`}),(0,j.jsx)(N,{python:`from flowgentra_ai.agent import AgentBuilder, AgentType
...
response3 = agent.execute_input("Tell me a joke about programming")`})]}),(0,j.jsxs)(Or,{id:`config-driven`,title:`Config-Driven Agents`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Define your agent in YAML for production deployments where non-engineers need to adjust the workflow.`}),(0,j.jsx)(N,{yaml:`# agent.yaml
...
agent = Agent.from_config_path("agent.yaml")
result = agent.run({"input": "What is 2 + 2?"})`})]}),(0,j.jsxs)(Or,{id:`memory-aware`,title:`MemoryAwareAgent`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`A pre-built agent for multi-user chatbots with per-user conversation memory.`}),(0,j.jsx)(N,{python:`from flowgentra_ai.agent import MemoryAwareAgent
from flowgentra_ai.memory import ConversationMemory
...
alice_followup = agent.chat("alice-123", "What's my name?")  # Remembers Alice`})]})]})}function Or({id:e,title:t,children:n}){return(0,j.jsxs)(`section`,{id:e,style:{marginBottom:48},children:[(0,j.jsx)(`h2`,{style:{fontSize:`1.5rem`,fontWeight:600,color:`#e6edf3`,marginBottom:16,marginTop:0},children:t}),n]})}var kr=[{id:`creating-client`,label:`Creating a Client`},{id:`sending-messages`,label:`Sending Messages`},{id:`tool-calling`,label:`Tool Calling`},{id:`streaming`,label:`Streaming`}];function Ar(){let{language:e}=M();return(0,j.jsxs)(P,{anchors:kr,children:[(0,j.jsx)(`h1`,{style:{fontSize:`2rem`,fontWeight:700,color:`#e6edf3`,letterSpacing:`-0.02em`,marginBottom:8,marginTop:0},children:`LLM Integration`}),(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:40,lineHeight:1.7},children:`Flowgentra provides a unified LLM client that works with 7 providers. You configure it once and use the same API regardless of whether you're using OpenAI, Anthropic, or a local Ollama model.`}),(0,j.jsxs)(jr,{id:`creating-client`,title:`Creating a Client`,children:[(0,j.jsx)(N,{rust:`use flowgentra_ai::llm::{LLMConfig, LLMClient};
...
print(response.role)      # "assistant"`})}),(0,j.jsxs)(jr,{id:`tool-calling`,title:`Tool Calling`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Flowgentra supports function calling with all major providers. Define your tools and the LLM will call them automatically.`}),(0,j.jsx)(N,{python:`from flowgentra_ai.llm import ToolDefinition
...
if response.has_tool_calls():
    for call in response.tool_calls:
        if call.name == "calculator":
            ...
            print(f"Result: {result}")  # Result: 4`})]}),(0,j.jsxs)(jr,{id:`streaming`,title:`Streaming`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`For real-time responses, use streaming. The client yields chunks as they're generated.`}),(0,j.jsx)(N,{python:`# Streaming responses
for chunk in client.chat_stream([
    Message.user("Write a short story")
]):
    print(chunk.content, end="", flush=True)
print()  # New line at end`})]})]})}function jr({id:e,title:t,children:n}){return(0,j.jsxs)(`section`,{id:e,style:{marginBottom:48},children:[(0,j.jsx)(`h2`,{style:{fontSize:`1.5rem`,fontWeight:600,color:`#e6edf3`,marginBottom:16,marginTop:0},children:t}),n]})}var Mr=[{id:`checkpointers`,label:`Checkpointers`},{id:`conversation-memory`,label:`Conversation Memory`},{id:`memory-aware-agents`,label:`Memory-Aware Agents`},{id:`threading`,label:`Threading & Sessions`},{id:`persistence`,label:`Persistence`}];function Nr(){let{language:e}=M();return(0,j.jsxs)(P,{anchors:Mr,children:[(0,j.jsx)(`h1`,{style:{fontSize:`2rem`,fontWeight:700,color:`#e6edf3`,letterSpacing:`-0.02em`,marginBottom:8,marginTop:0},children:`Memory Management`}),(0,j.jsxs)(`p`,{style:{color:`#8b949e`,marginBottom:40,lineHeight:1.7},children:[`Memory in Flowgentra refers to both `,(0,j.jsx)(`strong`,{style:{color:`#e6edf3`},children:`conversation history`}),` (what the agent remembers from previous interactions) and `,(0,j.jsx)(`strong`,{style:{color:`#e6edf3`},children:`checkpointing`}),` (persisting graph state to disk for resumability).`]}),(0,j.jsxs)(Pr,{id:`checkpointers`,title:`Checkpointers`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Checkpointers save your graph's state to disk after each node execution. This lets you resume interrupted workflows and provides audit trails.`}),(0,j.jsx)(N,{rust:`use flowgentra_ai::checkpointer::FileCheckpointer;
...
context = "\\n".join(f"{msg.role}: {msg.content}" for msg in recent)`}),(0,j.jsx)(`h4`,{style:{color:`#e6edf3`,fontSize:`1.1rem`,fontWeight:600,marginBottom:12,marginTop:20},children:`ConversationMemory Methods`}),(0,j.jsx)(`div`,{style:{background:`#0d1117`,border:`1px solid #21262d`,borderRadius:8,padding:`20px`,marginBottom:20},children:(0,j.jsxs)(`table`,{style:{width:`100%`,borderCollapse:`collapse`,color:`#8b949e`},children:[(0,j.jsx)(`thead`,{children:(0,j.jsxs)(`tr`,{children:[(0,j.jsx)(`th`,{style:{textAlign:`left`,padding:`8px`,borderBottom:`1px solid #21262d`,color:`#e6edf3`},children:`Method`}),(0,j.jsx)(`th`,{style:{textAlign:`left`,padding:`8px`,borderBottom:`1px solid #21262d`,color:`#e6edf3`},children:`Parameters`}),(0,j.jsx)(`th`,{style:{textAlign:`left`,padding:`8px`,borderBottom:`1px solid #21262d`,color:`#e6edf3`},children:`Returns`}),(0,j.jsx)(`th`,{style:{textAlign:`left`,padding:`8px`,borderBottom:`1px solid #21262d`,color:`#e6edf3`},children:`Description`})]})}),(0,j.jsxs)(`tbody`,{children:[(0,j.jsxs)(`tr`,{children:[(0,j.jsx)(`td`,{style:{padding:`8px`,borderBottom:`1px solid #21262d`,fontFamily:`monospace`,fontSize:`0.9em`},children:`add_user_message(content)`}),(0,j.jsx)(`td`,{style:{padding:`8px`,borderBottom:`1px solid #21262d`},children:`content: str`}),(0,j.jsx)(`td`,{style:{padding:`8px`,borderBottom:`1px solid #21262d`},children:`None`}),(0,j.jsx)(`td`,{style:{padding:`8px`,borderBottom:`1px solid #21262d`},children:`Add a user message to memory`})]}),(0,j.jsxs)(`tr`,{children:[(0,j.jsx)(`td`,{style:{padding:`8px`,borderBottom:`1px solid #21262d`,fontFamily:`monospace`,fontSize:`0.9em`},children:`add_assistant_message(content)`}),(0,j.jsx)(`td`,{style:{padding:`8px`,borderBottom:`1px solid #21262d`},children:`content: str`}),(0,j.jsx)(`td`,{style:{padding:`8px`,borderBottom:`1px solid #21262d`},children:`None`}),(0,j.jsx)(`td`,{style:{padding:`8px`,borderBottom:`1px solid #21262d`},children:`Add an assistant response to memory`})]}),(0,j.jsxs)(`tr`,{children:[(0,j.jsx)(`td`,{style:{padding:`8px`,borderBottom:`1px solid #21262d`,fontFamily:`monospace`,fontSize:`0.9em`},children:`get_recent(n)`}),(0,j.jsx)(`td`,{style:{padding:`8px`,borderBottom:`1px solid #21262d`},children:`n: int`}),(0,j.jsx)(`td`,{style:{padding:`8px`,borderBottom:`1px solid #21262d`},children:`List[Message]`}),(0,j.jsx)(`td`,{style:{padding:`8px`,borderBottom:`1px solid #21262d`},children:`Get last n messages`})]}),(0,j.jsxs)(`tr`,{children:[(0,j.jsx)(`td`,{style:{padding:`8px`,borderBottom:`1px solid #21262d`,fontFamily:`monospace`,fontSize:`0.9em`},children:`clear()`}),(0,j.jsx)(`td`,{style:{padding:`8px`,borderBottom:`1px solid #21262d`},children:`None`}),(0,j.jsx)(`td`,{style:{padding:`8px`,borderBottom:`1px solid #21262d`},children:`None`}),(0,j.jsx)(`td`,{style:{padding:`8px`,borderBottom:`1px solid #21262d`},children:`Clear all messages from memory`})]}),(0,j.jsxs)(`tr`,{children:[(0,j.jsx)(`td`,{style:{padding:`8px`,fontFamily:`monospace`,fontSize:`0.9em`},children:`get_all()`}),(0,j.jsx)(`td`,{style:{padding:`8px`},children:`None`}),(0,j.jsx)(`td`,{style:{padding:`8px`},children:`List[Message]`}),(0,j.jsx)(`td`,{style:{padding:`8px`},children:`Get all messages in memory`})]})]})]})})]}),(0,j.jsxs)(Pr,{id:`memory-aware-agents`,title:`Memory-Aware Agents`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Memory-aware agents automatically manage conversation history and can handle multi-turn conversations without manual state management.`}),(0,j.jsx)(N,{rust:`use flowgentra_ai::agent::MemoryAwareAgent;
...
# User B's conversation (completely separate)
result_b = graph.invoke(initial_state, thread_id="user_b")`})]}),(0,j.jsxs)(Pr,{id:`persistence`,title:`Persistence & Recovery`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Checkpoints let you recover from crashes and resume long-running workflows. You can also inspect execution history for debugging.`}),(0,j.jsx)(N,{rust:`// List all checkpoints for a thread
...
# Continue execution from where it left off
final_result = graph.invoke(resumed_state, thread_id="user_a")`})]})]})}function Pr({id:e,title:t,children:n}){return(0,j.jsxs)(`section`,{id:e,style:{marginBottom:48},children:[(0,j.jsx)(`h2`,{style:{fontSize:`1.5rem`,fontWeight:600,color:`#e6edf3`,marginBottom:16,marginTop:0},children:t}),n]})}var Fr=[{id:`human-in-loop-node`,label:`HumanInTheLoop Node`},{id:`approval-workflows`,label:`Approval Workflows`},{id:`intervention-points`,label:`Intervention Points`},{id:`feedback-loops`,label:`Feedback & Corrections`}];function Ir(){let{language:e}=M();return(0,j.jsxs)(P,{anchors:Fr,children:[(0,j.jsx)(`h1`,{style:{fontSize:`2rem`,fontWeight:700,color:`#e6edf3`,letterSpacing:`-0.02em`,marginBottom:8,marginTop:0},children:`Human-in-the-Loop Workflows`}),(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:40,lineHeight:1.7},children:`Human-in-the-loop (HITL) workflows let humans intervene in automated processes. Use this for quality control, safety checks, or when automation can't handle edge cases.`}),(0,j.jsxs)(Lr,{id:`human-in-loop-node`,title:`HumanInTheLoop Node`,children:[(0,j.jsxs)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:[`The `,(0,j.jsx)(`code`,{style:{background:`#161b22`,padding:`2px 6px`,borderRadius:3,fontSize:`0.9em`},children:`HumanInTheLoop`}),` node pauses execution and waits for human approval before continuing.`]}),(0,j.jsx)(N,{rust:`use flowgentra_ai::nodes::HumanInTheLoop;
...
print(result["answer"])`}),(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`This creates a complete RAG pipeline: retrieve relevant context, then generate an answer grounded in that context.`})]})]})}function Br({id:e,title:t,children:n}){return(0,j.jsxs)(`section`,{id:e,style:{marginBottom:48},children:[(0,j.jsx)(`h2`,{style:{fontSize:`1.5rem`,fontWeight:600,color:`#e6edf3`,marginBottom:16,marginTop:0},children:t}),n]})}var Vr=[{id:`tool-basics`,label:`Tool Basics`},{id:`creating-tools`,label:`Creating Tools`},{id:`tool-registry`,label:`Tool Registry`},{id:`tool-nodes`,label:`Tool Nodes`},{id:`tool-calling`,label:`Tool Calling with LLMs`},{id:`builtin-tools`,label:`Built-in Tools`}];function Hr(){let{language:e}=M();return(0,j.jsxs)(P,{anchors:Vr,children:[(0,j.jsx)(`h1`,{style:{fontSize:`2rem`,fontWeight:700,color:`#e6edf3`,letterSpacing:`-0.02em`,marginBottom:8,marginTop:0},children:`Tool Integration`}),(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:40,lineHeight:1.7},children:`Tools extend your agents with the ability to perform actions: call APIs, run calculations, search databases, or interact with external systems. Flowgentra provides a complete toolkit for building and using tools.`}),(0,j.jsxs)(Ur,{id:`tool-basics`,title:`Tool Basics`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`A tool is a function that an agent can call. Tools have names, descriptions, and schemas that tell the LLM how to use them.`}),(0,j.jsx)(N,{rust:`use flowgentra_ai::tools::{Tool, ToolSpec};
...
agent = Agent.create(
    ...
    tools=[github_api],
    model="gpt-4"
)`})]}),(0,j.jsxs)(Ur,{id:`tool-registry`,title:`Tool Registry`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`The tool registry manages all available tools and makes them discoverable by agents.`}),(0,j.jsx)(N,{rust:`use flowgentra_ai::tools::ToolRegistry;
...
# Or get all tools
all_tools = registry.all_tools()`})]}),(0,j.jsxs)(Ur,{id:`tool-nodes`,title:`Tool Nodes`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Tool nodes execute tools within your graph workflow.`}),(0,j.jsx)(N,{rust:`use flowgentra_ai::nodes::ToolNode;
...
graph = builder.compile()`})]}),(0,j.jsxs)(Ur,{id:`tool-calling`,title:`Tool Calling with LLMs`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Modern LLMs can call tools directly. Flowgentra handles the tool calling protocol.`}),(0,j.jsx)(N,{python:`from flowgentra_ai.llm import LLMClient
...
graph = builder.compile()`}),(0,j.jsx)(`h4`,{style:{color:`#e6edf3`,fontSize:`1.1rem`,fontWeight:600,marginBottom:12,marginTop:20},children:`TimeoutConfig Parameters`}),(0,j.jsx)(`div`,{style:{background:`#0d1117`,border:`1px solid #21262d`,borderRadius:8,padding:`20px`,marginBottom:20},children:(0,j.jsxs)(`table`,{style:{width:`100%`,borderCollapse:`collapse`,color:`#8b949e`},children:[(0,j.jsx)(`thead`,{children:(0,j.jsxs)(`tr`,{children:[(0,j.jsx)(`th`,{style:{textAlign:`left`,padding:`8px`,borderBottom:`1px solid #21262d`,color:`#e6edf3`},children:`Parameter`}),(0,j.jsx)(`th`,{style:{textAlign:`left`,padding:`8px`,borderBottom:`1px solid #21262d`,color:`#e6edf3`},children:`Type`}),(0,j.jsx)(`th`,{style:{textAlign:`left`,padding:`8px`,borderBottom:`1px solid #21262d`,color:`#e6edf3`},children:`Default`}),(0,j.jsx)(`th`,{style:{textAlign:`left`,padding:`8px`,borderBottom:`1px solid #21262d`,color:`#e6edf3`},children:`Description`})]})}),(0,j.jsxs)(`tbody`,{children:[(0,j.jsxs)(`tr`,{children:[(0,j.jsx)(`td`,{style:{padding:`8px`,borderBottom:`1px solid #21262d`,fontFamily:`monospace`,fontSize:`0.9em`},children:`timeout`}),(0,j.jsx)(`td`,{style:{padding:`8px`,borderBottom:`1px solid #21262d`},children:`float`}),(0,j.jsx)(`td`,{style:{padding:`8px`,borderBottom:`1px solid #21262d`},children:`30.0`}),(0,j.jsx)(`td`,{style:{padding:`8px`,borderBottom:`1px solid #21262d`},children:`Maximum time to wait before timing out (seconds)`})]}),(0,j.jsxs)(`tr`,{children:[(0,j.jsx)(`td`,{style:{padding:`8px`,fontFamily:`monospace`,fontSize:`0.9em`},children:`on_timeout`}),(0,j.jsx)(`td`,{style:{padding:`8px`},children:`function`}),(0,j.jsx)(`td`,{style:{padding:`8px`},children:`None`}),(0,j.jsx)(`td`,{style:{padding:`8px`},children:`Function called when timeout occurs, receives state and returns modified state`})]})]})]})})]}),(0,j.jsxs)(Kr,{id:`fallback-nodes`,title:`Fallback Strategies`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`When primary operations fail, try alternative approaches.`}),(0,j.jsx)(N,{rust:`use flowgentra_ai::nodes::FallbackNode;
...
graph = builder.compile()`}),(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Fallbacks are especially useful for external API calls where you have multiple providers or cached alternatives.`})]}),(0,j.jsxs)(Kr,{id:`error-recovery`,title:`Error Recovery Patterns`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Design your graphs to handle errors gracefully and recover when possible.`}),(0,j.jsx)(`h3`,{style:{color:`#e6edf3`,fontSize:`1.25rem`,fontWeight:600,marginBottom:12,marginTop:20},children:`Circuit Breaker Pattern`}),(0,j.jsx)(N,{python:`class CircuitBreakerNode:
        ...
        try:
            ...
            return {
                **state,
                ...
                "error": str(e),
                "degraded": True
            }`})]}),(0,j.jsxs)(Kr,{id:`monitoring`,title:`Error Monitoring`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Track errors and performance to improve your system's reliability.`}),(0,j.jsx)(N,{rust:`use flowgentra_ai::observability::{ErrorTracker, MetricsCollector};
...
export API_VERSION="2"`}),(0,j.jsxs)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:[`Variable syntax: `,(0,j.jsx)(`code`,{style:{background:`#161b22`,padding:`2px 6px`,borderRadius:3,fontSize:`0.9em`},children:`$VAR_NAME`}),` or `,(0,j.jsx)(`code`,{style:{background:`#161b22`,padding:`2px 6px`,borderRadius:3,fontSize:`0.9em`},children:`$VAR_NAME:-default`}),` for defaults.`]})]}),(0,j.jsxs)(Yr,{id:`yaml-schema`,title:`YAML Schema Reference`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Complete reference for all configuration options.`}),(0,j.jsx)(`h3`,{style:{color:`#e6edf3`,fontSize:`1.25rem`,fontWeight:600,marginBottom:12,marginTop:20},children:`LLM Configuration`}),(0,j.jsx)(N,{yaml:`llm:
  ...
  edges:                                             # Optional, explicit edges
    - from: source_node
      to: target_node
      condition: "state.get('score', 0) > 0.8"      # Optional, conditional routing`})]}),(0,j.jsxs)(Yr,{id:`config-validation`,title:`Configuration Validation`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Flowgentra validates your configuration at load time to catch errors early.`}),(0,j.jsx)(N,{rust:`use flowgentra_ai::agent::Agent;
...
print(f"Quality score: {score:.2f}")`}];function si(){return(0,j.jsxs)(P,{anchors:oi.map(e=>({id:e.id,label:e.title})),children:[(0,j.jsx)(`h1`,{style:{fontSize:`2rem`,fontWeight:700,color:`#e6edf3`,letterSpacing:`-0.02em`,marginBottom:8,marginTop:0},children:`Examples`}),(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:48,lineHeight:1.7},children:`Real-world usage patterns. Toggle between Rust and Python using the language switcher.`}),oi.map((e,t)=>(0,j.jsxs)(`section`,{id:e.id,style:{marginBottom:60,paddingBottom:60,borderBottom:t<oi.length-1?`1px solid #21262d`:`none`},children:[(0,j.jsx)(`div`,{style:{display:`flex`,alignItems:`baseline`,gap:12,marginBottom:8},children:(0,j.jsxs)(`span`,{style:{fontSize:`0.75rem`,fontWeight:600,color:`var(--accent)`,background:`var(--accent-dim)`,border:`1px solid var(--accent)`,borderRadius:10,padding:`2px 10px`},children:[`Example `,t+1]})}),(0,j.jsx)(`h2`,{style:{fontSize:`1.375rem`,fontWeight:600,color:`#e6edf3`,marginBottom:8,marginTop:0},children:e.title}),(0,j.jsx)(`p`,{style:{color:`#8b949e`,lineHeight:1.7,marginBottom:20},children:e.description}),(0,j.jsx)(N,{rust:e.rust,python:e.python})]},e.id))]})}var ci=[{version:`0.1.3`,date:`2025-04-05`,tag:`latest`,changes:[{type:`fix`,text:"Python: all submodule imports now work correctly (use `from flowgentra_ai.graph import StateGraph`, not `from flowgentra import …`)"},{type:`fix`,text:"Python: `Agent.create()` now takes `model` string instead of `llm` LLMClient object; use `run_with_input(str)` on the returned agent"},{type:`fix`,text:"Python: `StateGraph.invoke()` accepts a plain `dict` — do not wrap with `State()`"},{type:`fix`,text:`Python: fixed 9 compile errors in PyO3 bindings (rayon, schema_version, tool extraction, GIL cloning, type mismatches)`},{type:`fix`,text:"Python: `conversation_memory.rs` extra brace syntax error resolved"},{type:`fix`,text:"Python: `LLMClient` constructor no longer requires a pre-built config object"},{type:`breaking`,text:'Python: `Agent.create(llm=…)` removed — pass `model="gpt-4o"` string instead'},{type:`breaking`,text:"Python: top-level `from flowgentra import StateGraph` removed — use submodule imports"},{type:`docs`,text:"Updated all code examples to use correct `flowgentra_ai.*` submodule import paths"}],rust:`# Cargo.toml
...
flowgentra = "0.4"`,python:`pip install "flowgentra==0.4.0"`},{version:`0.3.2`,date:`2024-10-15`,tag:null,changes:[{type:`fix`,text:"Python: handle `None` return values from node functions"},{type:`fix`,text:`Rust: correct borrow checker error with recursive graphs`},{type:`docs`,text:`Improve error messages for missing entry node`}],rust:`flowgentra = "0.3.2"`,python:`pip install "flowgentra==0.3.2"`},{version:`0.3.0`,date:`2024-09-01`,tag:null,changes:[{type:`feat`,text:`Initial Python bindings via PyO3`},{type:`feat`,text:`TypedDict state support in Python`},{type:`feat`,text:`Async node support in both languages`},{type:`breaking`,text:"Renamed `Graph::new` to `StateGraph::builder`"}],rust:`flowgentra = "0.3"`,python:`pip install "flowgentra==0.3.0"`}],li={feat:{bg:`rgba(35,134,54,0.15)`,color:`#3fb950`,label:`feat`},fix:{bg:`rgba(248,81,73,0.15)`,color:`#f85149`,label:`fix`},perf:{bg:`rgba(53,114,165,0.15)`,color:`#79c0ff`,label:`perf`},docs:{bg:`rgba(139,148,158,0.15)`,color:`#8b949e`,label:`docs`},breaking:{bg:`rgba(210,153,34,0.15)`,color:`#e3b341`,label:`breaking`}};function ui(){return(0,j.jsxs)(P,{children:[(0,j.jsx)(`h1`,{style:{fontSize:`2rem`,fontWeight:700,color:`#e6edf3`,letterSpacing:`-0.02em`,marginBottom:8,marginTop:0},children:`Changelog`}),(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:48,lineHeight:1.7},children:`All notable changes to Flowgentra. The language switcher shows the install snippet for each version.`}),ci.map((e,t)=>(0,j.jsxs)(`article`,{style:{marginBottom:52,paddingBottom:52,borderBottom:t<ci.length-1?`1px solid #21262d`:`none`},children:[(0,j.jsxs)(`div`,{style:{display:`flex`,flexWrap:`wrap`,alignItems:`center`,gap:10,marginBottom:6},children:[(0,j.jsxs)(`h2`,{style:{fontFamily:`JetBrains Mono, monospace`,fontSize:`1.25rem`,color:`#e6edf3`,margin:0},children:[`v`,e.version]}),e.tag&&(0,j.jsx)(`span`,{style:{background:`rgba(35,134,54,0.15)`,color:`#3fb950`,border:`1px solid rgba(35,134,54,0.4)`,borderRadius:10,fontSize:`0.75rem`,padding:`2px 10px`,fontWeight:500},children:e.tag}),(0,j.jsx)(`span`,{style:{color:`#484f58`,fontSize:`0.875rem`,marginLeft:`auto`},children:e.date})]}),(0,j.jsx)(`ul`,{style:{listStyle:`none`,padding:0,margin:`16px 0 20px`},children:e.changes.map((t,n)=>{let r=li[t.type]||li.docs;return(0,j.jsxs)(`li`,{style:{display:`flex`,alignItems:`baseline`,gap:10,padding:`6px 0`,borderBottom:n<e.changes.length-1?`1px solid #161b22`:`none`},children:[(0,j.jsx)(`span`,{style:{background:r.bg,color:r.color,fontSize:`0.7rem`,fontWeight:600,padding:`2px 7px`,borderRadius:4,flexShrink:0,fontFamily:`JetBrains Mono, monospace`},children:r.label}),(0,j.jsx)(`span`,{style:{color:`#c9d1d9`,lineHeight:1.6,fontSize:`0.9375rem`},children:t.text})]},n)})}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`p`,{style:{fontSize:`0.8125rem`,color:`#8b949e`,marginBottom:8},children:`Install this version:`}),(0,j.jsx)(N,{rust:e.rust,python:e.python})]})]},e.version))]})}var di=[{id:`overview`,label:`Overview`},{id:`supported-formats`,label:`Supported Formats`},{id:`loading-single`,label:`Loading Single Documents`},{id:`loading-directories`,label:`Loading Directories`},{id:`ingestion-pipeline`,label:`Ingestion Pipeline`},{id:`pdf-processing`,label:`PDF Processing`},{id:`custom-loaders`,label:`Custom Loaders`},{id:`error-handling`,label:`Error Handling`},{id:`best-practices`,label:`Best Practices`}];function fi(){let{language:e}=M();return(0,j.jsxs)(P,{anchors:di,children:[(0,j.jsx)(`h1`,{style:{fontSize:`2rem`,fontWeight:700,color:`#e6edf3`,letterSpacing:`-0.02em`,marginBottom:8,marginTop:0},children:`Document Loading`}),(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:40,lineHeight:1.7},children:`Flowgentra can load documents from various sources and formats, automatically extracting text content and metadata for use in RAG systems.`}),(0,j.jsx)(pi,{id:`overview`,title:`Overview`,children:(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Document loading is the first step in building a RAG system. Flowgentra provides comprehensive support for loading documents from files, directories, and various formats with automatic content extraction and metadata preservation.`})}),(0,j.jsxs)(pi,{id:`supported-formats`,title:`Supported Formats`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Flowgentra supports loading documents from:`}),(0,j.jsxs)(`ul`,{style:{color:`#8b949e`,marginBottom:16,paddingLeft:`20px`},children:[(0,j.jsxs)(`li`,{children:[(0,j.jsx)(`strong`,{style:{color:`#e6edf3`},children:`Plain text`}),` (.txt) - Direct text loading`]}),(0,j.jsxs)(`li`,{children:[(0,j.jsx)(`strong`,{style:{color:`#e6edf3`},children:`Markdown`}),` (.md) - Preserves structure and formatting`]}),(0,j.jsxs)(`li`,{children:[(0,j.jsx)(`strong`,{style:{color:`#e6edf3`},children:`HTML`}),` (.html) - Strips tags, preserves text content`]}),(0,j.jsxs)(`li`,{children:[(0,j.jsx)(`strong`,{style:{color:`#e6edf3`},children:`PDF`}),` (.pdf) - Extracts text content from PDF documents`]}),(0,j.jsxs)(`li`,{children:[(0,j.jsx)(`strong`,{style:{color:`#e6edf3`},children:`JSON`}),` (.json) - Structured data loading`]}),(0,j.jsxs)(`li`,{children:[(0,j.jsx)(`strong`,{style:{color:`#e6edf3`},children:`CSV`}),` (.csv) - Tabular data processing`]})]})]}),(0,j.jsx)(pi,{id:`loading-single`,title:`Loading Single Documents`,children:(0,j.jsx)(N,{rust:`use flowgentra_ai::data::load_document;
use std::path::Path;
...
print(f"Author: {doc.metadata.get('author')}")`})}),(0,j.jsxs)(pi,{id:`loading-directories`,title:`Loading Directories`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Load all documents from a directory recursively:`}),(0,j.jsx)(N,{rust:`use flowgentra_ai::data::load_directory;
...
for doc in documents:
    ...
    print(f"Metadata: {doc.metadata}")`})]}),(0,j.jsxs)(pi,{id:`ingestion-pipeline`,title:`Ingestion Pipeline`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`For production use, use the ingestion pipeline which provides progress tracking and error handling:`}),(0,j.jsx)(N,{python:`from flowgentra_ai.document_loaders import IngestionPipeline
...
print(f"Total characters: {stats.total_characters}")`})]}),(0,j.jsxs)(pi,{id:`pdf-processing`,title:`PDF Processing`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Special handling for PDF files:`}),(0,j.jsx)(N,{python:`from flowgentra_ai.document_loaders import extract_pdf
...
print(f"Subject: {doc.metadata.get('subject')}")`})]}),(0,j.jsxs)(pi,{id:`custom-loaders`,title:`Custom Document Types`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`For unsupported formats, you can create custom loaders:`}),(0,j.jsx)(N,{python:`from flowgentra_ai.document_loaders import LoadedDocument, FileType
...
doc = load_custom_format("./my_custom_format.xyz")`})]}),(0,j.jsxs)(pi,{id:`error-handling`,title:`Error Handling`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Document loading can fail for various reasons:`}),(0,j.jsx)(N,{python:`from flowgentra_ai.document_loaders import load_document
...
results = rag_config.retriever.retrieve("What is AI?", top_k=5)`})]}),(0,j.jsxs)(gi,{id:`performance`,title:`Performance Comparison`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Here's how the rerankers compare in practice:`}),(0,j.jsx)(`div`,{style:{background:`#0d1117`,border:`1px solid #21262d`,borderRadius:8,padding:`20px`,marginBottom:20,fontFamily:`monospace`,fontSize:`0.9rem`,color:`#8b949e`},children:`Reranker Performance (100 documents, approximate):

RRF:           5-10ms   | Good accuracy, fast
Cross-Encoder: 100-500ms | Excellent accuracy, slower
LLM:           1-5s     | Custom accuracy, very slow
No-Op:         <1ms     | No change, instant`})]}),(0,j.jsxs)(gi,{id:`configuration`,title:`Configuration Tips`,children:[(0,j.jsx)(`h4`,{style:{color:`#e6edf3`,fontSize:`1.1rem`,fontWeight:600,marginBottom:12,marginTop:20},children:`Choosing RRF Parameters`}),(0,j.jsx)(N,{python:`# Conservative (preserves original ranking more)
...
for i, query_result in enumerate(results.query_results):
    print(f"Query {i}: HR={query_result.hit_rate}, MRR={query_result.mrr}")`})]}),(0,j.jsxs)(yi,{id:`generation-evaluation`,title:`Generation Evaluation`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Evaluate answer quality beyond retrieval:`}),(0,j.jsx)(N,{python:`from flowgentra_ai.evaluation import evaluate_output_score
...
print(f"Average answer quality: {sum(scores)/len(scores):.3f}")`})]}),(0,j.jsxs)(yi,{id:`custom-metrics`,title:`Custom Metrics`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Create your own evaluation metrics:`}),(0,j.jsx)(N,{python:`from flowgentra_ai.evaluation import EvaluationResult
...
)`})]}),(0,j.jsxs)(yi,{id:`ab-testing`,title:`A/B Testing Configurations`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Compare different RAG configurations:`}),(0,j.jsx)(N,{python:`from flowgentra_ai.rag import RAGConfig
...
builder.add_node("quality_loop", loop_config)`})]}),(0,j.jsxs)(F,{id:`subgraph-nodes`,title:`Subgraph Nodes`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Compose complex workflows from smaller graphs.`}),(0,j.jsx)(N,{python:`from flowgentra_ai.nodes import SubgraphNodeConfig
...
main_builder.add_node("process_documents", subgraph_config)`})]}),(0,j.jsxs)(F,{id:`join-nodes`,title:`Join Nodes`,children:[(0,j.jsx)(`p`,{style:{color:`#8b949e`,marginBottom:16},children:`Synchronize multiple parallel branches.`}),(0,j.jsx)(N,{python:`from flowgentra_ai.nodes import JoinNodeConfig, JoinType
...
)`})]})]})}function F({id:e,title:t,children:n}){return(0,j.jsxs)(`section`,{id:e,style:{marginBottom:48},children:[(0,j.jsx)(`h2`,{style:{fontSize:`1.5rem`,fontWeight:600,color:`#e6edf3`,marginBottom:16,marginTop:0},children:t}),n]})}function Si(){return(0,j.jsx)(Xn,{children:(0,j.jsx)(Dn,{basename:`/flowgentra-ai-docs`,children:(0,j.jsxs)(`div`,{style:{minHeight:`100vh`,display:`flex`,flexDirection:`column`},children:[(0,j.jsx)($n,{}),(0,j.jsx)(`div`,{style:{flex:1},children:(0,j.jsxs)(zt,{children:[(0,j.jsx)(A,{path:`/`,element:(0,j.jsx)(or,{})}),(0,j.jsx)(A,{path:`/docs/getting-started`,element:(0,j.jsx)(lr,{})}),(0,j.jsx)(A,{path:`/docs/installation`,element:(0,j.jsx)(fr,{})}),(0,j.jsx)(A,{path:`/docs/what-is-flowgentra`,element:(0,j.jsx)(hr,{})}),(0,j.jsx)(A,{path:`/docs/concepts/graphs`,element:(0,j.jsx)(vr,{})}),(0,j.jsx)(A,{path:`/docs/concepts/nodes`,element:(0,j.jsx)(xr,{})}),(0,j.jsx)(A,{path:`/docs/concepts/state`,element:(0,j.jsx)(wr,{})}),(0,j.jsx)(A,{path:`/docs/guides/agents`,element:(0,j.jsx)(Dr,{})}),(0,j.jsx)(A,{path:`/docs/guides/llm-client`,element:(0,j.jsx)(Ar,{})}),(0,j.jsx)(A,{path:`/docs/guides/memory`,element:(0,j.jsx)(Nr,{})}),(0,j.jsx)(A,{path:`/docs/guides/human-in-loop`,element:(0,j.jsx)(Ir,{})}),(0,j.jsx)(A,{path:`/docs/guides/rag`,element:(0,j.jsx)(zr,{})}),(0,j.jsx)(A,{path:`/docs/guides/tools`,element:(0,j.jsx)(Hr,{})}),(0,j.jsx)(A,{path:`/docs/guides/error-handling`,element:(0,j.jsx)(Gr,{})}),(0,j.jsx)(A,{path:`/docs/guides/configuration`,element:(0,j.jsx)(Jr,{})}),(0,j.jsx)(A,{path:`/docs/guides/document-loaders`,element:(0,j.jsx)(fi,{})}),(0,j.jsx)(A,{path:`/docs/guides/reranking`,element:(0,j.jsx)(hi,{})}),(0,j.jsx)(A,{path:`/docs/guides/evaluation`,element:(0,j.jsx)(vi,{})}),(0,j.jsx)(A,{path:`/docs/guides/advanced-nodes`,element:(0,j.jsx)(xi,{})}),(0,j.jsx)(A,{path:`/docs/best-practices`,element:(0,j.jsx)(Zr,{})}),(0,j.jsx)(A,{path:`/docs/faq`,element:(0,j.jsx)(ei,{})}),(0,j.jsx)(A,{path:`/docs/api/:topicId`,element:(0,j.jsx)(ai,{})}),(0,j.jsx)(A,{path:`/docs/api-reference`,element:(0,j.jsx)(Lt,{to:`/docs/api/state-graph`,replace:!0})}),(0,j.jsx)(A,{path:`/docs/examples`,element:(0,j.jsx)(si,{})}),(0,j.jsx)(A,{path:`/docs/changelog`,element:(0,j.jsx)(ui,{})}),(0,j.jsx)(A,{path:`/docs`,element:(0,j.jsx)(Lt,{to:`/docs/getting-started`,replace:!0})}),(0,j.jsx)(A,{path:`*`,element:(0,j.jsx)(Lt,{to:`/`,replace:!0})})]})})]})})})}(0,y.createRoot)(document.getElementById(`root`)).render((0,j.jsx)(v.StrictMode,{children:(0,j.jsx)(Si,{})}));export{s as n,S as t};